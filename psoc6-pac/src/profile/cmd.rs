...
pub type START_TR_W<'a, const O: u8> = crate::BitWriter<'a, CMD_SPEC, O>;
...
pub type STOP_TR_W<'a, const O: u8> = crate::BitWriter<'a, CMD_SPEC, O>;
...
pub type CLR_ALL_CNT_W<'a, const O: u8> = crate::BitWriter<'a, CMD_SPEC, O>;
impl R {
