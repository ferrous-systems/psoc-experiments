...
pub type CNT_DURATION_W<'a, const O: u8> = crate::BitWriter<'a, CTL_SPEC, O>;
...
pub type REF_CLK_SEL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CTL_SPEC, 3, O, REF_CLK_SEL_A>;
...
pub type MON_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, CTL_SPEC, 7, O>;
