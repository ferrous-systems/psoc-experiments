...
pub type TRIGGER_LEVEL_W<'a, const O: u8> = crate::FieldWriter<'a, TX_FIFO_CTRL_SPEC, 8, O>;
...
pub type CLEAR_W<'a, const O: u8> = crate::BitWriter<'a, TX_FIFO_CTRL_SPEC, O>;
...
pub type FREEZE_W<'a, const O: u8> = crate::BitWriter<'a, TX_FIFO_CTRL_SPEC, O>;
impl R {
