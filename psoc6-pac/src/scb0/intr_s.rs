...
pub type I2C_ARB_LOST_W<'a, const O: u8> = crate::BitWriter<'a, INTR_S_SPEC, O>;
...
pub type I2C_NACK_W<'a, const O: u8> = crate::BitWriter<'a, INTR_S_SPEC, O>;
...
pub type I2C_ACK_W<'a, const O: u8> = crate::BitWriter<'a, INTR_S_SPEC, O>;
...
pub type I2C_WRITE_STOP_W<'a, const O: u8> = crate::BitWriter<'a, INTR_S_SPEC, O>;
...
pub type I2C_STOP_W<'a, const O: u8> = crate::BitWriter<'a, INTR_S_SPEC, O>;
...
pub type I2C_START_W<'a, const O: u8> = crate::BitWriter<'a, INTR_S_SPEC, O>;
...
pub type I2C_ADDR_MATCH_W<'a, const O: u8> = crate::BitWriter<'a, INTR_S_SPEC, O>;
...
pub type I2C_GENERAL_W<'a, const O: u8> = crate::BitWriter<'a, INTR_S_SPEC, O>;
...
pub type I2C_BUS_ERROR_W<'a, const O: u8> = crate::BitWriter<'a, INTR_S_SPEC, O>;
...
pub type SPI_EZ_WRITE_STOP_W<'a, const O: u8> = crate::BitWriter<'a, INTR_S_SPEC, O>;
...
pub type SPI_EZ_STOP_W<'a, const O: u8> = crate::BitWriter<'a, INTR_S_SPEC, O>;
...
pub type SPI_BUS_ERROR_W<'a, const O: u8> = crate::BitWriter<'a, INTR_S_SPEC, O>;
impl R {
