...
pub type I2C_ARB_LOST_W<'a, const O: u8> = crate::BitWriter<'a, INTR_M_SET_SPEC, O>;
...
pub type I2C_NACK_W<'a, const O: u8> = crate::BitWriter<'a, INTR_M_SET_SPEC, O>;
...
pub type I2C_ACK_W<'a, const O: u8> = crate::BitWriter<'a, INTR_M_SET_SPEC, O>;
...
pub type I2C_STOP_W<'a, const O: u8> = crate::BitWriter<'a, INTR_M_SET_SPEC, O>;
...
pub type I2C_BUS_ERROR_W<'a, const O: u8> = crate::BitWriter<'a, INTR_M_SET_SPEC, O>;
...
pub type SPI_DONE_W<'a, const O: u8> = crate::BitWriter<'a, INTR_M_SET_SPEC, O>;
impl R {
