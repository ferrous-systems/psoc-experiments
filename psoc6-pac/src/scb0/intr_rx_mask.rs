...
pub type TRIGGER_W<'a, const O: u8> = crate::BitWriter<'a, INTR_RX_MASK_SPEC, O>;
...
pub type NOT_EMPTY_W<'a, const O: u8> = crate::BitWriter<'a, INTR_RX_MASK_SPEC, O>;
...
pub type FULL_W<'a, const O: u8> = crate::BitWriter<'a, INTR_RX_MASK_SPEC, O>;
...
pub type OVERFLOW_W<'a, const O: u8> = crate::BitWriter<'a, INTR_RX_MASK_SPEC, O>;
...
pub type UNDERFLOW_W<'a, const O: u8> = crate::BitWriter<'a, INTR_RX_MASK_SPEC, O>;
...
pub type BLOCKED_W<'a, const O: u8> = crate::BitWriter<'a, INTR_RX_MASK_SPEC, O>;
...
pub type FRAME_ERROR_W<'a, const O: u8> = crate::BitWriter<'a, INTR_RX_MASK_SPEC, O>;
...
pub type PARITY_ERROR_W<'a, const O: u8> = crate::BitWriter<'a, INTR_RX_MASK_SPEC, O>;
...
pub type BAUD_DETECT_W<'a, const O: u8> = crate::BitWriter<'a, INTR_RX_MASK_SPEC, O>;
...
pub type BREAK_DETECT_W<'a, const O: u8> = crate::BitWriter<'a, INTR_RX_MASK_SPEC, O>;
impl R {
