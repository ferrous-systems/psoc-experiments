...
pub type M_START_W<'a, const O: u8> = crate::BitWriter<'a, I2C_M_CMD_SPEC, O>;
...
pub type M_START_ON_IDLE_W<'a, const O: u8> = crate::BitWriter<'a, I2C_M_CMD_SPEC, O>;
...
pub type M_ACK_W<'a, const O: u8> = crate::BitWriter<'a, I2C_M_CMD_SPEC, O>;
...
pub type M_NACK_W<'a, const O: u8> = crate::BitWriter<'a, I2C_M_CMD_SPEC, O>;
...
pub type M_STOP_W<'a, const O: u8> = crate::BitWriter<'a, I2C_M_CMD_SPEC, O>;
impl R {
