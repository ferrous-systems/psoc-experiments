...
pub type TRIGGER_W<'a, const O: u8> = crate::BitWriter<'a, INTR_TX_MASK_SPEC, O>;
...
pub type NOT_FULL_W<'a, const O: u8> = crate::BitWriter<'a, INTR_TX_MASK_SPEC, O>;
...
pub type EMPTY_W<'a, const O: u8> = crate::BitWriter<'a, INTR_TX_MASK_SPEC, O>;
...
pub type OVERFLOW_W<'a, const O: u8> = crate::BitWriter<'a, INTR_TX_MASK_SPEC, O>;
...
pub type UNDERFLOW_W<'a, const O: u8> = crate::BitWriter<'a, INTR_TX_MASK_SPEC, O>;
...
pub type BLOCKED_W<'a, const O: u8> = crate::BitWriter<'a, INTR_TX_MASK_SPEC, O>;
...
pub type UART_NACK_W<'a, const O: u8> = crate::BitWriter<'a, INTR_TX_MASK_SPEC, O>;
...
pub type UART_DONE_W<'a, const O: u8> = crate::BitWriter<'a, INTR_TX_MASK_SPEC, O>;
...
pub type UART_ARB_LOST_W<'a, const O: u8> = crate::BitWriter<'a, INTR_TX_MASK_SPEC, O>;
impl R {
