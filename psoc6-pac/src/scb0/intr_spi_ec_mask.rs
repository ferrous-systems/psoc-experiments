...
pub type WAKE_UP_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPI_EC_MASK_SPEC, O>;
...
pub type EZ_STOP_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPI_EC_MASK_SPEC, O>;
...
pub type EZ_WRITE_STOP_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPI_EC_MASK_SPEC, O>;
...
pub type EZ_READ_STOP_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPI_EC_MASK_SPEC, O>;
impl R {
