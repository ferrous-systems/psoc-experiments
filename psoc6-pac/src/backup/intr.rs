...
pub type ALARM1_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPEC, O>;
#[doc = "Field `ALARM2` reader - Alarm 2 Interrupt"]
pub type ALARM2_R = crate::BitReader;
#[doc = "Field `ALARM2` writer - Alarm 2 Interrupt"]
pub type ALARM2_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPEC, O>;
...
pub type CENTURY_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPEC, O>;
impl R {
