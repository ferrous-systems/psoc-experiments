...
pub type CALIB_VAL_W<'a, const O: u8> = crate::FieldWriter<'a, CAL_CTL_SPEC, 6, O>;
...
pub type CALIB_SIGN_W<'a, const O: u8> = crate::BitWriter<'a, CAL_CTL_SPEC, O>;
...
pub type CAL_OUT_W<'a, const O: u8> = crate::BitWriter<'a, CAL_CTL_SPEC, O>;
impl R {
