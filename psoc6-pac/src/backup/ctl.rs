...
pub type WCO_EN_W<'a, const O: u8> = crate::BitWriter<'a, CTL_SPEC, O>;
...
pub type CLK_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, CTL_SPEC, 2, O, CLK_SEL_A>;
...
pub type PRESCALER_W<'a, const O: u8> = crate::FieldWriter<'a, CTL_SPEC, 2, O>;
...
pub type WCO_BYPASS_W<'a, const O: u8> = crate::BitWriter<'a, CTL_SPEC, O>;
...
pub type VDDBAK_CTL_W<'a, const O: u8> = crate::FieldWriter<'a, CTL_SPEC, 2, O>;
...
pub type VBACKUP_MEAS_W<'a, const O: u8> = crate::BitWriter<'a, CTL_SPEC, O>;
...
pub type EN_CHARGE_KEY_W<'a, const O: u8> = crate::FieldWriter<'a, CTL_SPEC, 8, O>;
impl R {
