...
pub type RTC_SEC_R = crate::FieldReader;
#[doc = "Field `RTC_SEC` writer - Calendar seconds in BCD, 0-59"]
pub type RTC_SEC_W<'a, const O: u8> = crate::FieldWriter<'a, RTC_TIME_SPEC, 7, O>;
#[doc = "Field `RTC_MIN` reader - Calendar minutes in BCD, 0-59"]
pub type RTC_MIN_R = crate::FieldReader;
#[doc = "Field `RTC_MIN` writer - Calendar minutes in BCD, 0-59"]
pub type RTC_MIN_W<'a, const O: u8> = crate::FieldWriter<'a, RTC_TIME_SPEC, 7, O>;
...
pub type RTC_HOUR_R = crate::FieldReader;
...
pub type RTC_HOUR_W<'a, const O: u8> = crate::FieldWriter<'a, RTC_TIME_SPEC, 6, O>;
#[doc = "Field `CTRL_12HR` reader - Select 12/24HR mode: 1=12HR, 0=24HR"]
pub type CTRL_12HR_R = crate::BitReader;
#[doc = "Field `CTRL_12HR` writer - Select 12/24HR mode: 1=12HR, 0=24HR"]
pub type CTRL_12HR_W<'a, const O: u8> = crate::BitWriter<'a, RTC_TIME_SPEC, O>;
...
pub type RTC_DAY_R = crate::FieldReader;
...
pub type RTC_DAY_W<'a, const O: u8> = crate::FieldWriter<'a, RTC_TIME_SPEC, 3, O>;
impl R {
