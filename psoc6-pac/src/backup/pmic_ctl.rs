...
pub type UNLOCK_W<'a, const O: u8> = crate::FieldWriter<'a, PMIC_CTL_SPEC, 8, O>;
#[doc = "Field `POLARITY` reader - N/A"]
pub type POLARITY_R = crate::BitReader;
#[doc = "Field `POLARITY` writer - N/A"]
pub type POLARITY_W<'a, const O: u8> = crate::BitWriter<'a, PMIC_CTL_SPEC, O>;
...
pub type PMIC_EN_OUTEN_W<'a, const O: u8> = crate::BitWriter<'a, PMIC_CTL_SPEC, O>;
...
pub type PMIC_ALWAYSEN_W<'a, const O: u8> = crate::BitWriter<'a, PMIC_CTL_SPEC, O>;
...
pub type PMIC_EN_W<'a, const O: u8> = crate::BitWriter<'a, PMIC_CTL_SPEC, O>;
impl R {
