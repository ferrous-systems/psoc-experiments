...
pub type ALM_SEC_W<'a, const O: u8> = crate::FieldWriter<'a, ALM1_TIME_SPEC, 7, O>;
...
pub type ALM_SEC_EN_W<'a, const O: u8> = crate::BitWriter<'a, ALM1_TIME_SPEC, O>;
...
pub type ALM_MIN_W<'a, const O: u8> = crate::FieldWriter<'a, ALM1_TIME_SPEC, 7, O>;
...
pub type ALM_MIN_EN_W<'a, const O: u8> = crate::BitWriter<'a, ALM1_TIME_SPEC, O>;
...
pub type ALM_HOUR_W<'a, const O: u8> = crate::FieldWriter<'a, ALM1_TIME_SPEC, 6, O>;
...
pub type ALM_HOUR_EN_W<'a, const O: u8> = crate::BitWriter<'a, ALM1_TIME_SPEC, O>;
...
pub type ALM_DAY_W<'a, const O: u8> = crate::FieldWriter<'a, ALM1_TIME_SPEC, 3, O>;
...
pub type ALM_DAY_EN_W<'a, const O: u8> = crate::BitWriter<'a, ALM1_TIME_SPEC, O>;
impl R {
