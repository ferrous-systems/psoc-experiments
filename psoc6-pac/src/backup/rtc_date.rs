...
pub type RTC_DATE_W<'a, const O: u8> = crate::FieldWriter<'a, RTC_DATE_SPEC, 6, O>;
...
pub type RTC_MON_W<'a, const O: u8> = crate::FieldWriter<'a, RTC_DATE_SPEC, 5, O>;
...
pub type RTC_YEAR_W<'a, const O: u8> = crate::FieldWriter<'a, RTC_DATE_SPEC, 8, O>;
impl R {
