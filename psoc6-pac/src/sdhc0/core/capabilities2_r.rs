...
pub type SDR50_SUPPORT_R = crate::BitReader;
...
pub type SDR104_SUPPORT_R = crate::BitReader;
...
pub type DDR50_SUPPORT_R = crate::BitReader;
...
pub type UHS2_SUPPORT_R = crate::BitReader;
...
pub type DRV_TYPEA_R = crate::BitReader;
...
pub type DRV_TYPEC_R = crate::BitReader;
...
pub type DRV_TYPED_R = crate::BitReader;
#[doc = "Field `RETUNE_CNT` reader - N/A"]
pub type RETUNE_CNT_R = crate::FieldReader;
...
pub type USE_TUNING_SDR50_R = crate::BitReader;
#[doc = "Field `RE_TUNING_MODES` reader - N/A"]
pub type RE_TUNING_MODES_R = crate::FieldReader;
...
pub type CLK_MUL_R = crate::FieldReader;
...
pub type ADMA3_SUPPORT_R = crate::BitReader;
...
pub type VDD2_18V_SUPPORT_R = crate::BitReader;
impl R {
...
impl crate::Resettable for CAPABILITIES2_R_SPEC {
    const RESET_VALUE: Self::Ux = 0x0800_0077;
}
