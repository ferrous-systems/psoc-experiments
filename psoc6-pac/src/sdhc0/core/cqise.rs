...
pub type HAC_STE_W<'a, const O: u8> = crate::BitWriter<'a, CQISE_SPEC, O>;
...
pub type TCC_STE_W<'a, const O: u8> = crate::BitWriter<'a, CQISE_SPEC, O>;
...
pub type RED_STE_W<'a, const O: u8> = crate::BitWriter<'a, CQISE_SPEC, O>;
...
pub type TCL_STE_W<'a, const O: u8> = crate::BitWriter<'a, CQISE_SPEC, O>;
...
pub type GCE_STE_W<'a, const O: u8> = crate::BitWriter<'a, CQISE_SPEC, O>;
...
pub type ICCE_STE_W<'a, const O: u8> = crate::BitWriter<'a, CQISE_SPEC, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gce_ste(&mut self) -> GCE_STE_W<4> {
        GCE_STE_W::new(self)
    }
    #[doc = "Bit 5 - Invalid Crypto Configuration Error interrupt status enable Values: - 0x1 (INT_STS_ENABLE): CQIS.ICCE is set when its interrupt condition is active - 0x0 (INT_STS_DISABLE): CQIS.ICCE is disabled"]
    #[inline(always)]
    #[must_use]
    pub fn icce_ste(&mut self) -> ICCE_STE_W<5> {
        ICCE_STE_W::new(self)
    }
