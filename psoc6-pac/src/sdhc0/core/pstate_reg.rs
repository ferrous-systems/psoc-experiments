...
pub struct R(crate::R<PSTATE_REG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PSTATE_REG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PSTATE_REG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PSTATE_REG_SPEC>) -> Self {
        R(reader)
    }
}
...
pub type CMD_INHIBIT_DAT_R = crate::BitReader;
...
pub type DAT_LINE_ACTIVE_R = crate::BitReader;
...
pub type DAT_7_4_R = crate::FieldReader;
...
pub type WR_XFER_ACTIVE_R = crate::BitReader;
...
pub type RD_XFER_ACTIVE_R = crate::BitReader;
...
pub type BUF_WR_ENABLE_R = crate::BitReader;
...
pub type BUF_RD_ENABLE_R = crate::BitReader;
...
pub type CARD_INSERTED_R = crate::BitReader;
...
pub type CARD_STABLE_R = crate::BitReader;
...
pub type CARD_DETECT_PIN_LEVEL_R = crate::BitReader;
...
pub type WR_PROTECT_SW_LVL_R = crate::BitReader;
...
pub type DAT_3_0_R = crate::FieldReader;
...
pub type CMD_LINE_LVL_R = crate::BitReader;
...
pub type HOST_REG_VOL_R = crate::BitReader;
...
pub type CMD_ISSU_ERR_R = crate::BitReader;
...
pub type SUB_CMD_STAT_R = crate::BitReader;
impl R {
...
Line Signal Level This bit is used to check the DAT line level to recover from errors and for debugging. These bits reflect the value of the sd_dat_in (lower nibble) signal."]
    ...
    pub fn host_reg_vol(&self) -> HOST_REG_VOL_R {
        HOST_REG_VOL_R::new(((self.bits >> 25) & 1) != 0)
    }
    ...
    pub fn cmd_issu_err(&self) -> CMD_ISSU_ERR_R {
        CMD_ISSU_ERR_R::new(((self.bits >> 27) & 1) != 0)
    }
...
#[doc = "Present State Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pstate_reg](index.html) module"]
pub struct PSTATE_REG_SPEC;
impl crate::RegisterSpec for PSTATE_REG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pstate_reg::R](R) reader structure"]
impl crate::Readable for PSTATE_REG_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets PSTATE_REG to value 0"]
impl crate::Resettable for PSTATE_REG_SPEC {
