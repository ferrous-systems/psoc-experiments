...
pub type SQSCMD_IDLE_TMR_W<'a, const O: u8> = crate::FieldWriter<'a, CQSSC1_SPEC, 16, O, u16>;
...
pub type SQSCMD_BLK_CNT_W<'a, const O: u8> = crate::FieldWriter<'a, CQSSC1_SPEC, 4, O>;
impl R {
