...
pub struct R(crate::R<CURR_CAPABILITIES2_R_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CURR_CAPABILITIES2_R_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CURR_CAPABILITIES2_R_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CURR_CAPABILITIES2_R_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Maximum Current Capabilities Register - 32 to 63\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [curr_capabilities2_r](index.html) module"]
