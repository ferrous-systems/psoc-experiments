...
pub type HAC_W<'a, const O: u8> = crate::BitWriter<'a, CQIS_SPEC, O>;
...
pub type TCC_W<'a, const O: u8> = crate::BitWriter<'a, CQIS_SPEC, O>;
...
pub type RED_W<'a, const O: u8> = crate::BitWriter<'a, CQIS_SPEC, O>;
...
pub type TCL_W<'a, const O: u8> = crate::BitWriter<'a, CQIS_SPEC, O>;
#[doc = "Field `GCE` reader - N/A"]
pub type GCE_R = crate::BitReader;
#[doc = "Field `GCE` writer - N/A"]
pub type GCE_W<'a, const O: u8> = crate::BitWriter<'a, CQIS_SPEC, O>;
#[doc = "Field `ICCE` reader - N/A"]
pub type ICCE_R = crate::BitReader;
#[doc = "Field `ICCE` writer - N/A"]
pub type ICCE_W<'a, const O: u8> = crate::BitWriter<'a, CQIS_SPEC, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gce(&mut self) -> GCE_W<4> {
        GCE_W::new(self)
    }
    #[doc = "Bit 5 - N/A"]
    #[inline(always)]
    #[must_use]
    pub fn icce(&mut self) -> ICCE_W<5> {
        ICCE_W::new(self)
    }
