...
pub type CMD_TOUT_ERR_STAT_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, ERROR_INT_STAT_EN_R_SPEC, O>;
...
pub type CMD_CRC_ERR_STAT_EN_W<'a, const O: u8> = crate::BitWriter<'a, ERROR_INT_STAT_EN_R_SPEC, O>;
...
pub type CMD_IDX_ERR_STAT_EN_W<'a, const O: u8> = crate::BitWriter<'a, ERROR_INT_STAT_EN_R_SPEC, O>;
...
pub type CUR_LMT_ERR_STAT_EN_W<'a, const O: u8> = crate::BitWriter<'a, ERROR_INT_STAT_EN_R_SPEC, O>;
...
pub type ADMA_ERR_STAT_EN_W<'a, const O: u8> = crate::BitWriter<'a, ERROR_INT_STAT_EN_R_SPEC, O>;
...
pub type TUNING_ERR_STAT_EN_W<'a, const O: u8> = crate::BitWriter<'a, ERROR_INT_STAT_EN_R_SPEC, O>;
...
pub type RESP_ERR_STAT_EN_W<'a, const O: u8> = crate::BitWriter<'a, ERROR_INT_STAT_EN_R_SPEC, O>;
...
pub type VENDOR_ERR_STAT_EN1_W<'a, const O: u8> = crate::BitWriter<'a, ERROR_INT_STAT_EN_R_SPEC, O>;
...
pub type VENDOR_ERR_STAT_EN2_W<'a, const O: u8> = crate::BitWriter<'a, ERROR_INT_STAT_EN_R_SPEC, O>;
...
pub type VENDOR_ERR_STAT_EN3_W<'a, const O: u8> = crate::BitWriter<'a, ERROR_INT_STAT_EN_R_SPEC, O>;
impl R {
