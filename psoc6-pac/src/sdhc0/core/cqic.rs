...
pub type TOUT_VAL_W<'a, const O: u8> = crate::FieldWriter<'a, CQIC_SPEC, 7, O>;
...
pub type TOUT_VAL_WEN_W<'a, const O: u8> = crate::BitWriter<'a, CQIC_SPEC, O>;
...
pub type INTC_TH_W<'a, const O: u8> = crate::FieldWriter<'a, CQIC_SPEC, 5, O>;
...
pub type INTC_TH_WEN_W<'a, const O: u8> = crate::BitWriter<'a, CQIC_SPEC, O>;
...
pub type INTC_RST_W<'a, const O: u8> = crate::BitWriter<'a, CQIC_SPEC, O>;
...
pub type INTC_EN_W<'a, const O: u8> = crate::BitWriter<'a, CQIC_SPEC, O>;
impl R {
