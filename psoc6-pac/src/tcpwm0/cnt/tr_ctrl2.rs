...
pub type CC_MATCH_MODE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, TR_CTRL2_SPEC, 2, O, CC_MATCH_MODE_A>;
...
pub type OVERFLOW_MODE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, TR_CTRL2_SPEC, 2, O, OVERFLOW_MODE_A>;
...
pub type UNDERFLOW_MODE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, TR_CTRL2_SPEC, 2, O, UNDERFLOW_MODE_A>;
