...
pub type CAPTURE_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, TR_CTRL0_SPEC, 4, O>;
...
pub type COUNT_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, TR_CTRL0_SPEC, 4, O>;
...
pub type RELOAD_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, TR_CTRL0_SPEC, 4, O>;
...
pub type STOP_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, TR_CTRL0_SPEC, 4, O>;
...
pub type START_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, TR_CTRL0_SPEC, 4, O>;
impl R {
