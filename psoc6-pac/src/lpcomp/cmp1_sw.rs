...
pub type CMP1_IP1_W<'a, const O: u8> = crate::BitWriter<'a, CMP1_SW_SPEC, O>;
...
pub type CMP1_AP1_W<'a, const O: u8> = crate::BitWriter<'a, CMP1_SW_SPEC, O>;
...
pub type CMP1_BP1_W<'a, const O: u8> = crate::BitWriter<'a, CMP1_SW_SPEC, O>;
...
pub type CMP1_IN1_W<'a, const O: u8> = crate::BitWriter<'a, CMP1_SW_SPEC, O>;
...
pub type CMP1_AN1_W<'a, const O: u8> = crate::BitWriter<'a, CMP1_SW_SPEC, O>;
...
pub type CMP1_BN1_W<'a, const O: u8> = crate::BitWriter<'a, CMP1_SW_SPEC, O>;
...
pub type CMP1_VN1_W<'a, const O: u8> = crate::BitWriter<'a, CMP1_SW_SPEC, O>;
impl R {
