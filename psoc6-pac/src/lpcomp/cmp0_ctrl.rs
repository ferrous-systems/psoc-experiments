...
pub type MODE0_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CMP0_CTRL_SPEC, 2, O, MODE0_A>;
...
pub type HYST0_W<'a, const O: u8> = crate::BitWriter<'a, CMP0_CTRL_SPEC, O>;
...
pub type INTTYPE0_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CMP0_CTRL_SPEC, 2, O, INTTYPE0_A>;
...
pub type DSI_BYPASS0_W<'a, const O: u8> = crate::BitWriter<'a, CMP0_CTRL_SPEC, O>;
...
pub type DSI_LEVEL0_W<'a, const O: u8> = crate::BitWriter<'a, CMP0_CTRL_SPEC, O>;
impl R {
