...
pub type MODE1_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CMP1_CTRL_SPEC, 2, O, MODE1_A>;
...
pub type HYST1_W<'a, const O: u8> = crate::BitWriter<'a, CMP1_CTRL_SPEC, O>;
...
pub type INTTYPE1_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CMP1_CTRL_SPEC, 2, O, INTTYPE1_A>;
...
pub type DSI_BYPASS1_W<'a, const O: u8> = crate::BitWriter<'a, CMP1_CTRL_SPEC, O>;
...
pub type DSI_LEVEL1_W<'a, const O: u8> = crate::BitWriter<'a, CMP1_CTRL_SPEC, O>;
impl R {
