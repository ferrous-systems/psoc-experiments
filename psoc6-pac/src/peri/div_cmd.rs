...
pub type DIV_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, DIV_CMD_SPEC, 8, O>;
...
pub type TYPE_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, DIV_CMD_SPEC, 2, O>;
...
pub type PA_DIV_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, DIV_CMD_SPEC, 8, O>;
...
pub type PA_TYPE_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, DIV_CMD_SPEC, 2, O>;
...
pub type DISABLE_W<'a, const O: u8> = crate::BitWriter<'a, DIV_CMD_SPEC, O>;
...
pub type ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, DIV_CMD_SPEC, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn type_sel(&mut self) -> TYPE_SEL_W<8> {
        TYPE_SEL_W::new(self)
    }
    #[doc = "Bits 16:23 - (PA_TYPE_SEL, PA_DIV_SEL) specifies the divider to which phase alignment is performed for the clock enable command. Any enabled divider can be used as reference. This allows all dividers to be aligned with each other, even when they are enabled at different times. If PA_DIV_SEL is '255' and PA_TYPE_SEL is '3', 'clk_peri' is used as reference."]
    #[inline(always)]
    #[must_use]
    pub fn pa_div_sel(&mut self) -> PA_DIV_SEL_W<16> {
        PA_DIV_SEL_W::new(self)
    }
    #[doc = "Bits 24:25 - Specifies the divider type of the divider to which phase alignment is performed for the clock enable command: 0: 8.0 (integer) clock dividers. 1: 16.0 (integer) clock dividers. 2: 16.5 (fractional) clock dividers. 3: 24.5 (fractional) clock dividers."]
    #[inline(always)]
    #[must_use]
    pub fn pa_type_sel(&mut self) -> PA_TYPE_SEL_W<24> {
