...
pub type P_W<'a, const O: u8> = crate::BitWriter<'a, CH_CTL_SPEC, O>;
...
pub type NS_W<'a, const O: u8> = crate::BitWriter<'a, CH_CTL_SPEC, O>;
...
pub type B_W<'a, const O: u8> = crate::BitWriter<'a, CH_CTL_SPEC, O>;
...
pub type PC_W<'a, const O: u8> = crate::FieldWriter<'a, CH_CTL_SPEC, 4, O>;
...
pub type PRIO_W<'a, const O: u8> = crate::FieldWriter<'a, CH_CTL_SPEC, 2, O>;
...
pub type PREEMPTABLE_W<'a, const O: u8> = crate::BitWriter<'a, CH_CTL_SPEC, O>;
...
pub type ENABLED_W<'a, const O: u8> = crate::BitWriter<'a, CH_CTL_SPEC, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn preemptable(&mut self) -> PREEMPTABLE_W<11> {
