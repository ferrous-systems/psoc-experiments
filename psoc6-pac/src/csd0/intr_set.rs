...
pub type SAMPLE_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SET_SPEC, O>;
...
pub type INIT_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SET_SPEC, O>;
...
pub type ADC_RES_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SET_SPEC, O>;
impl R {
