...
pub type SW_SFPM_W<'a, const O: u8> = crate::FieldWriter<'a, SW_CMP_P_SEL_SPEC, 3, O>;
...
pub type SW_SFPT_W<'a, const O: u8> = crate::FieldWriter<'a, SW_CMP_P_SEL_SPEC, 3, O>;
...
pub type SW_SFPS_W<'a, const O: u8> = crate::FieldWriter<'a, SW_CMP_P_SEL_SPEC, 3, O>;
...
pub type SW_SFMA_W<'a, const O: u8> = crate::BitWriter<'a, SW_CMP_P_SEL_SPEC, O>;
...
pub type SW_SFMB_W<'a, const O: u8> = crate::BitWriter<'a, SW_CMP_P_SEL_SPEC, O>;
...
pub type SW_SFCA_W<'a, const O: u8> = crate::BitWriter<'a, SW_CMP_P_SEL_SPEC, O>;
...
pub type SW_SFCB_W<'a, const O: u8> = crate::BitWriter<'a, SW_CMP_P_SEL_SPEC, O>;
impl R {
