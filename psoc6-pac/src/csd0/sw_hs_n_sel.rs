...
pub type SW_HCCC_W<'a, const O: u8> = crate::BitWriter<'a, SW_HS_N_SEL_SPEC, O>;
...
pub type SW_HCCD_W<'a, const O: u8> = crate::BitWriter<'a, SW_HS_N_SEL_SPEC, O>;
...
pub type SW_HCRH_W<'a, const O: u8> = crate::FieldWriter<'a, SW_HS_N_SEL_SPEC, 3, O>;
...
pub type SW_HCRL_W<'a, const O: u8> = crate::FieldWriter<'a, SW_HS_N_SEL_SPEC, 3, O>;
impl R {
