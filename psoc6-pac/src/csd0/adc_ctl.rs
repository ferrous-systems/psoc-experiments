...
pub type ADC_TIME_W<'a, const O: u8> = crate::FieldWriter<'a, ADC_CTL_SPEC, 8, O>;
...
pub type ADC_MODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, ADC_CTL_SPEC, 2, O, ADC_MODE_A>;
