...
pub type HSCMP_EN_W<'a, const O: u8> = crate::BitWriter<'a, HSCMP_SPEC, O, HSCMP_EN_A>;
...
pub type HSCMP_INVERT_W<'a, const O: u8> = crate::BitWriter<'a, HSCMP_SPEC, O>;
...
pub type AZ_EN_W<'a, const O: u8> = crate::BitWriter<'a, HSCMP_SPEC, O>;
impl R {
