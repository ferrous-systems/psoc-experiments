...
pub type SW_IRBY_W<'a, const O: u8> = crate::BitWriter<'a, SW_AMUXBUF_SEL_SPEC, O>;
...
pub type SW_IRLB_W<'a, const O: u8> = crate::BitWriter<'a, SW_AMUXBUF_SEL_SPEC, O>;
...
pub type SW_ICA_W<'a, const O: u8> = crate::BitWriter<'a, SW_AMUXBUF_SEL_SPEC, O>;
...
pub type SW_ICB_W<'a, const O: u8> = crate::FieldWriter<'a, SW_AMUXBUF_SEL_SPEC, 3, O>;
...
pub type SW_IRLI_W<'a, const O: u8> = crate::BitWriter<'a, SW_AMUXBUF_SEL_SPEC, O>;
...
pub type SW_IRH_W<'a, const O: u8> = crate::BitWriter<'a, SW_AMUXBUF_SEL_SPEC, O>;
...
pub type SW_IRL_W<'a, const O: u8> = crate::BitWriter<'a, SW_AMUXBUF_SEL_SPEC, O>;
impl R {
