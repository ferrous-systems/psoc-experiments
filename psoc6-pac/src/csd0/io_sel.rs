...
pub type CSD_TX_OUT_W<'a, const O: u8> = crate::FieldWriter<'a, IO_SEL_SPEC, 4, O>;
...
pub type CSD_TX_OUT_EN_W<'a, const O: u8> = crate::FieldWriter<'a, IO_SEL_SPEC, 4, O>;
...
pub type CSD_TX_AMUXB_EN_W<'a, const O: u8> = crate::FieldWriter<'a, IO_SEL_SPEC, 4, O>;
...
pub type CSD_TX_N_OUT_W<'a, const O: u8> = crate::FieldWriter<'a, IO_SEL_SPEC, 4, O>;
...
pub type CSD_TX_N_OUT_EN_W<'a, const O: u8> = crate::FieldWriter<'a, IO_SEL_SPEC, 4, O>;
...
pub type CSD_TX_N_AMUXA_EN_W<'a, const O: u8> = crate::FieldWriter<'a, IO_SEL_SPEC, 4, O>;
impl R {
