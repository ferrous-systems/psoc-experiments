...
pub type START_W<'a, const O: u8> = crate::BitWriter<'a, SEQ_START_SPEC, O>;
...
pub type SEQ_MODE_W<'a, const O: u8> = crate::BitWriter<'a, SEQ_START_SPEC, O>;
...
pub type ABORT_W<'a, const O: u8> = crate::BitWriter<'a, SEQ_START_SPEC, O>;
...
pub type DSI_START_EN_W<'a, const O: u8> = crate::BitWriter<'a, SEQ_START_SPEC, O>;
...
pub type AZ0_SKIP_W<'a, const O: u8> = crate::BitWriter<'a, SEQ_START_SPEC, O>;
...
pub type AZ1_SKIP_W<'a, const O: u8> = crate::BitWriter<'a, SEQ_START_SPEC, O>;
impl R {
