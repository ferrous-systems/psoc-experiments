...
pub type SW_HMPM_W<'a, const O: u8> = crate::BitWriter<'a, SW_HS_P_SEL_SPEC, O>;
...
pub type SW_HMPT_W<'a, const O: u8> = crate::BitWriter<'a, SW_HS_P_SEL_SPEC, O>;
...
pub type SW_HMPS_W<'a, const O: u8> = crate::BitWriter<'a, SW_HS_P_SEL_SPEC, O>;
...
pub type SW_HMMA_W<'a, const O: u8> = crate::BitWriter<'a, SW_HS_P_SEL_SPEC, O>;
...
pub type SW_HMMB_W<'a, const O: u8> = crate::BitWriter<'a, SW_HS_P_SEL_SPEC, O>;
...
pub type SW_HMCA_W<'a, const O: u8> = crate::BitWriter<'a, SW_HS_P_SEL_SPEC, O>;
...
pub type SW_HMCB_W<'a, const O: u8> = crate::BitWriter<'a, SW_HS_P_SEL_SPEC, O>;
...
pub type SW_HMRH_W<'a, const O: u8> = crate::BitWriter<'a, SW_HS_P_SEL_SPEC, O>;
impl R {
