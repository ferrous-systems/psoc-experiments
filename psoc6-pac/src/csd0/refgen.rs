...
pub type REFGEN_EN_W<'a, const O: u8> = crate::BitWriter<'a, REFGEN_SPEC, O, REFGEN_EN_A>;
...
pub type BYPASS_W<'a, const O: u8> = crate::BitWriter<'a, REFGEN_SPEC, O>;
...
pub type VDDA_EN_W<'a, const O: u8> = crate::BitWriter<'a, REFGEN_SPEC, O>;
...
pub type RES_EN_W<'a, const O: u8> = crate::BitWriter<'a, REFGEN_SPEC, O>;
...
pub type GAIN_W<'a, const O: u8> = crate::FieldWriter<'a, REFGEN_SPEC, 5, O>;
...
pub type VREFLO_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, REFGEN_SPEC, 5, O>;
...
pub type VREFLO_INT_W<'a, const O: u8> = crate::BitWriter<'a, REFGEN_SPEC, O>;
impl R {
