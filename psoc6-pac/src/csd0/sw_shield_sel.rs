...
pub type SW_HCAV_W<'a, const O: u8> = crate::FieldWriter<'a, SW_SHIELD_SEL_SPEC, 3, O>;
...
pub type SW_HCAG_W<'a, const O: u8> = crate::FieldWriter<'a, SW_SHIELD_SEL_SPEC, 3, O>;
#[doc = "Field `SW_HCBV` reader - N/A"]
pub type SW_HCBV_R = crate::FieldReader;
#[doc = "Field `SW_HCBV` writer - N/A"]
pub type SW_HCBV_W<'a, const O: u8> = crate::FieldWriter<'a, SW_SHIELD_SEL_SPEC, 3, O>;
...
pub type SW_HCBG_W<'a, const O: u8> = crate::FieldWriter<'a, SW_SHIELD_SEL_SPEC, 3, O>;
...
pub type SW_HCCV_W<'a, const O: u8> = crate::BitWriter<'a, SW_SHIELD_SEL_SPEC, O>;
...
pub type SW_HCCG_W<'a, const O: u8> = crate::BitWriter<'a, SW_SHIELD_SEL_SPEC, O>;
impl R {
    #[doc = "Bits 0:2 - N/A"]
    #[inline(always)]
