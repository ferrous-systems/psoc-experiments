...
pub type CSDCMP_EN_W<'a, const O: u8> = crate::BitWriter<'a, CSDCMP_SPEC, O, CSDCMP_EN_A>;
...
pub type POLARITY_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, CSDCMP_SPEC, 2, O, POLARITY_SEL_A>;
...
pub type CMP_PHASE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CSDCMP_SPEC, 2, O, CMP_PHASE_A>;
...
pub type CMP_MODE_W<'a, const O: u8> = crate::BitWriter<'a, CSDCMP_SPEC, O, CMP_MODE_A>;
...
pub type FEEDBACK_MODE_W<'a, const O: u8> = crate::BitWriter<'a, CSDCMP_SPEC, O, FEEDBACK_MODE_A>;
...
pub type AZ_EN_W<'a, const O: u8> = crate::BitWriter<'a, CSDCMP_SPEC, O>;
impl R {
