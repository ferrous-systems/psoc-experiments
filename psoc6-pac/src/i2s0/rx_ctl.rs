...
pub type B_CLOCK_INV_W<'a, const O: u8> = crate::BitWriter<'a, RX_CTL_SPEC, O, B_CLOCK_INV_A>;
...
pub type CH_NR_R = crate::FieldReader<CH_NR_A>;
...
impl crate::FieldSpec for CH_NR_A {
    type Ux = u8;
}
impl CH_NR_R {
    #[doc = "Get enumerated values variant"]
...
pub type CH_NR_W<'a, const O: u8> = crate::FieldWriterSafe<'a, RX_CTL_SPEC, 3, O, CH_NR_A>;
...
pub type MS_W<'a, const O: u8> = crate::BitWriter<'a, RX_CTL_SPEC, O, MS_A>;
...
pub type I2S_MODE_R = crate::FieldReader<I2S_MODE_A>;
...
impl crate::FieldSpec for I2S_MODE_A {
    type Ux = u8;
}
impl I2S_MODE_R {
    #[doc = "Get enumerated values variant"]
...
pub type I2S_MODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, RX_CTL_SPEC, 2, O, I2S_MODE_A>;
...
pub type WS_PULSE_W<'a, const O: u8> = crate::BitWriter<'a, RX_CTL_SPEC, O, WS_PULSE_A>;
...
pub type WD_EN_R = crate::BitReader;
#[doc = "Field `WD_EN` writer - Set watchdog for 'rx_ws_in' '0': Disabled. '1': Enabled."]
pub type WD_EN_W<'a, const O: u8> = crate::BitWriter<'a, RX_CTL_SPEC, O>;
...
pub type CH_LEN_R = crate::FieldReader<CH_LEN_A>;
...
impl crate::FieldSpec for CH_LEN_A {
    type Ux = u8;
}
impl CH_LEN_R {
    #[doc = "Get enumerated values variant"]
...
pub type CH_LEN_W<'a, const O: u8> = crate::FieldWriter<'a, RX_CTL_SPEC, 3, O, CH_LEN_A>;
...
pub type WORD_LEN_W<'a, const O: u8> = crate::FieldWriter<'a, RX_CTL_SPEC, 3, O, WORD_LEN_A>;
...
pub type BIT_EXTENSION_W<'a, const O: u8> = crate::BitWriter<'a, RX_CTL_SPEC, O>;
...
pub type SCKO_POL_R = crate::BitReader;
...
pub type SCKO_POL_W<'a, const O: u8> = crate::BitWriter<'a, RX_CTL_SPEC, O>;
...
pub type SCKI_POL_W<'a, const O: u8> = crate::BitWriter<'a, RX_CTL_SPEC, O>;
impl R {
...
impl crate::Resettable for RX_CTL_SPEC {
    const RESET_VALUE: Self::Ux = 0x0044_0510;
}
