...
pub type TX_REQ_EN_W<'a, const O: u8> = crate::BitWriter<'a, TR_CTL_SPEC, O>;
...
pub type RX_REQ_EN_W<'a, const O: u8> = crate::BitWriter<'a, TR_CTL_SPEC, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tx_req_en(&mut self) -> TX_REQ_EN_W<0> {
        TX_REQ_EN_W::new(self)
    }
    #[doc = "Bit 16 - Trigger output ('tr_i2s_rx_req') enable for requests of DMA transfer in reception '0': Disabled. '1': Enabled."]
    #[inline(always)]
    #[must_use]
