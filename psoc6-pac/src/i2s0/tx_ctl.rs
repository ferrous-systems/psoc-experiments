...
pub type B_CLOCK_INV_W<'a, const O: u8> = crate::BitWriter<'a, TX_CTL_SPEC, O, B_CLOCK_INV_A>;
...
pub type CH_NR_W<'a, const O: u8> = crate::FieldWriterSafe<'a, TX_CTL_SPEC, 3, O, CH_NR_A>;
...
pub type MS_W<'a, const O: u8> = crate::BitWriter<'a, TX_CTL_SPEC, O, MS_A>;
...
pub type I2S_MODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, TX_CTL_SPEC, 2, O, I2S_MODE_A>;
...
pub type WS_PULSE_W<'a, const O: u8> = crate::BitWriter<'a, TX_CTL_SPEC, O, WS_PULSE_A>;
...
pub type OVHDATA_R = crate::BitReader;
...
pub type OVHDATA_W<'a, const O: u8> = crate::BitWriter<'a, TX_CTL_SPEC, O>;
...
pub type WD_EN_W<'a, const O: u8> = crate::BitWriter<'a, TX_CTL_SPEC, O>;
...
pub type CH_LEN_W<'a, const O: u8> = crate::FieldWriter<'a, TX_CTL_SPEC, 3, O, CH_LEN_A>;
...
pub type WORD_LEN_W<'a, const O: u8> = crate::FieldWriter<'a, TX_CTL_SPEC, 3, O, WORD_LEN_A>;
...
pub type SCKO_POL_W<'a, const O: u8> = crate::BitWriter<'a, TX_CTL_SPEC, O>;
...
pub type SCKI_POL_W<'a, const O: u8> = crate::BitWriter<'a, TX_CTL_SPEC, O>;
impl R {
