...
pub type TX_TRIGGER_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SET_SPEC, O>;
...
pub type TX_NOT_FULL_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SET_SPEC, O>;
...
pub type TX_EMPTY_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SET_SPEC, O>;
...
pub type TX_OVERFLOW_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SET_SPEC, O>;
...
pub type TX_UNDERFLOW_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SET_SPEC, O>;
...
pub type TX_WD_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SET_SPEC, O>;
...
pub type RX_TRIGGER_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SET_SPEC, O>;
...
pub type RX_NOT_EMPTY_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SET_SPEC, O>;
...
pub type RX_FULL_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SET_SPEC, O>;
...
pub type RX_OVERFLOW_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SET_SPEC, O>;
...
pub type RX_UNDERFLOW_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SET_SPEC, O>;
...
pub type RX_WD_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SET_SPEC, O>;
impl R {
