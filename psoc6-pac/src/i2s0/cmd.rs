...
pub type TX_START_W<'a, const O: u8> = crate::BitWriter<'a, CMD_SPEC, O>;
...
pub type TX_PAUSE_W<'a, const O: u8> = crate::BitWriter<'a, CMD_SPEC, O>;
...
pub type RX_START_W<'a, const O: u8> = crate::BitWriter<'a, CMD_SPEC, O>;
impl R {
