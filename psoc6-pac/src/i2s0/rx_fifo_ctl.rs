...
pub type TRIGGER_LEVEL_W<'a, const O: u8> = crate::FieldWriter<'a, RX_FIFO_CTL_SPEC, 8, O>;
...
pub type CLEAR_W<'a, const O: u8> = crate::BitWriter<'a, RX_FIFO_CTL_SPEC, O>;
...
pub type FREEZE_W<'a, const O: u8> = crate::BitWriter<'a, RX_FIFO_CTL_SPEC, O>;
impl R {
