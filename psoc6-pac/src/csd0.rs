...
pub mod config;
#[doc = "SPARE (rw) register accessor: an alias for `Reg<SPARE_SPEC>`"]
...
pub mod intr_masked;
#[doc = "HSCMP (rw) register accessor: an alias for `Reg<HSCMP_SPEC>`"]
pub type HSCMP = crate::Reg<hscmp::HSCMP_SPEC>;
#[doc = "High Speed Comparator configuration"]
pub mod hscmp;
#[doc = "AMBUF (rw) register accessor: an alias for `Reg<AMBUF_SPEC>`"]
pub type AMBUF = crate::Reg<ambuf::AMBUF_SPEC>;
#[doc = "Reference Generator configuration"]
pub mod ambuf;
#[doc = "REFGEN (rw) register accessor: an alias for `Reg<REFGEN_SPEC>`"]
...
#[doc = "SW_AMUXBUF_SEL (rw) register accessor: an alias for `Reg<SW_AMUXBUF_SEL_SPEC>`"]
...
#[doc = "SW_BYP_SEL (rw) register accessor: an alias for `Reg<SW_BYP_SEL_SPEC>`"]
pub type SW_BYP_SEL = crate::Reg<sw_byp_sel::SW_BYP_SEL_SPEC>;
#[doc = "AMUXBUS bypass switches Waveform selection"]
pub mod sw_byp_sel;
#[doc = "SW_CMP_P_SEL (rw) register accessor: an alias for `Reg<SW_CMP_P_SEL_SPEC>`"]
...
#[doc = "SW_CMP_N_SEL (rw) register accessor: an alias for `Reg<SW_CMP_N_SEL_SPEC>`"]
...
#[doc = "SW_REFGEN_SEL (rw) register accessor: an alias for `Reg<SW_REFGEN_SEL_SPEC>`"]
...
#[doc = "SW_FW_MOD_SEL (rw) register accessor: an alias for `Reg<SW_FW_MOD_SEL_SPEC>`"]
...
#[doc = "SW_FW_TANK_SEL (rw) register accessor: an alias for `Reg<SW_FW_TANK_SEL_SPEC>`"]
...
#[doc = "SW_DSI_SEL (rw) register accessor: an alias for `Reg<SW_DSI_SEL_SPEC>`"]
pub type SW_DSI_SEL = crate::Reg<sw_dsi_sel::SW_DSI_SEL_SPEC>;
#[doc = "DSI output switch control Waveform selection"]
pub mod sw_dsi_sel;
#[doc = "IO_SEL (rw) register accessor: an alias for `Reg<IO_SEL_SPEC>`"]
pub type IO_SEL = crate::Reg<io_sel::IO_SEL_SPEC>;
#[doc = "IO output control Waveform selection"]
pub mod io_sel;
#[doc = "SEQ_TIME (rw) register accessor: an alias for `Reg<SEQ_TIME_SPEC>`"]
pub type SEQ_TIME = crate::Reg<seq_time::SEQ_TIME_SPEC>;
#[doc = "Sequencer Timing"]
pub mod seq_time;
#[doc = "SEQ_INIT_CNT (rw) register accessor: an alias for `Reg<SEQ_INIT_CNT_SPEC>`"]
...
#[doc = "SEQ_NORM_CNT (rw) register accessor: an alias for `Reg<SEQ_NORM_CNT_SPEC>`"]
...
#[doc = "ADC_CTL (rw) register accessor: an alias for `Reg<ADC_CTL_SPEC>`"]
pub type ADC_CTL = crate::Reg<adc_ctl::ADC_CTL_SPEC>;
#[doc = "ADC Control"]
pub mod adc_ctl;
#[doc = "SEQ_START (rw) register accessor: an alias for `Reg<SEQ_START_SPEC>`"]
pub type SEQ_START = crate::Reg<seq_start::SEQ_START_SPEC>;
#[doc = "Sequencer start"]
pub mod seq_start;
#[doc = "IDACA (rw) register accessor: an alias for `Reg<IDACA_SPEC>`"]
pub type IDACA = crate::Reg<idaca::IDACA_SPEC>;
#[doc = "IDACA Configuration"]
pub mod idaca;
#[doc = "IDACB (rw) register accessor: an alias for `Reg<IDACB_SPEC>`"]
