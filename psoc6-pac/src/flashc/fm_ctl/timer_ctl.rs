...
pub type PERIOD_W<'a, const O: u8> = crate::FieldWriter<'a, TIMER_CTL_SPEC, 15, O, u16>;
...
pub type SCALE_W<'a, const O: u8> = crate::BitWriter<'a, TIMER_CTL_SPEC, O>;
...
pub type AUTO_SEQUENCE_W<'a, const O: u8> = crate::BitWriter<'a, TIMER_CTL_SPEC, O>;
...
pub type PRE_PROG_W<'a, const O: u8> = crate::BitWriter<'a, TIMER_CTL_SPEC, O>;
...
pub type PRE_PROG_CSL_W<'a, const O: u8> = crate::BitWriter<'a, TIMER_CTL_SPEC, O>;
...
pub type PUMP_EN_W<'a, const O: u8> = crate::BitWriter<'a, TIMER_CTL_SPEC, O>;
...
pub type ACLK_EN_W<'a, const O: u8> = crate::BitWriter<'a, TIMER_CTL_SPEC, O>;
...
pub type TIMER_EN_W<'a, const O: u8> = crate::BitWriter<'a, TIMER_CTL_SPEC, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn scale(&mut self) -> SCALE_W<15> {
        SCALE_W::new(self)
    }
    #[doc = "Bit 24 - 1': Starts1 the HV automatic sequencing Cleared by HW"]
    #[inline(always)]
    #[must_use]
    pub fn auto_sequence(&mut self) -> AUTO_SEQUENCE_W<24> {
        AUTO_SEQUENCE_W::new(self)
    }
    #[doc = "Bit 25 - 1 during pre-program operation"]
    #[inline(always)]
    #[must_use]
