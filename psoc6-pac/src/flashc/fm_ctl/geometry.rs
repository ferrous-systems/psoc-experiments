...
pub type WORD_SIZE_LOG2_R = crate::FieldReader;
...
impl R {
    ...
    pub fn page_size_log2(&self) -> PAGE_SIZE_LOG2_R {
        PAGE_SIZE_LOG2_R::new(((self.bits >> 28) & 0x0f) as u8)
    }
}
