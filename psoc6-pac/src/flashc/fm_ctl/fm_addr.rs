...
pub type RA_W<'a, const O: u8> = crate::FieldWriter<'a, FM_ADDR_SPEC, 16, O, u16>;
#[doc = "Field `BA` reader - Bank address."]
pub type BA_R = crate::FieldReader;
#[doc = "Field `BA` writer - Bank address."]
pub type BA_W<'a, const O: u8> = crate::FieldWriter<'a, FM_ADDR_SPEC, 8, O>;
...
pub type AXA_W<'a, const O: u8> = crate::BitWriter<'a, FM_ADDR_SPEC, O>;
impl R {
