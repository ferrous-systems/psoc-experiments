...
pub type CLK_CLOCK_DIV_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, CLOCK_CTL_SPEC, 2, O, CLK_CLOCK_DIV_A>;
...
pub type MCLKQ_CLOCK_DIV_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, CLOCK_CTL_SPEC, 2, O, MCLKQ_CLOCK_DIV_A>;
...
pub type CKO_CLOCK_DIV_W<'a, const O: u8> = crate::FieldWriter<'a, CLOCK_CTL_SPEC, 4, O>;
...
pub type SINC_RATE_W<'a, const O: u8> = crate::FieldWriter<'a, CLOCK_CTL_SPEC, 7, O>;
impl R {
