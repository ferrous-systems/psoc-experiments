...
pub type WORD_LEN_W<'a, const O: u8> = crate::FieldWriterSafe<'a, DATA_CTL_SPEC, 2, O, WORD_LEN_A>;
...
pub type BIT_EXTENSION_W<'a, const O: u8> = crate::BitWriter<'a, DATA_CTL_SPEC, O>;
impl R {
