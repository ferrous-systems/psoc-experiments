...
pub type PGA_R_W<'a, const O: u8> = crate::FieldWriter<'a, CTL_SPEC, 4, O>;
...
pub type PGA_L_W<'a, const O: u8> = crate::FieldWriter<'a, CTL_SPEC, 4, O>;
...
pub type SOFT_MUTE_W<'a, const O: u8> = crate::BitWriter<'a, CTL_SPEC, O>;
...
pub type STEP_SEL_W<'a, const O: u8> = crate::BitWriter<'a, CTL_SPEC, O>;
