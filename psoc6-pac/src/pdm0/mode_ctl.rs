...
pub type PCM_CH_SET_R = crate::FieldReader<PCM_CH_SET_A>;
...
impl crate::FieldSpec for PCM_CH_SET_A {
    type Ux = u8;
}
impl PCM_CH_SET_R {
...
pub type PCM_CH_SET_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, MODE_CTL_SPEC, 2, O, PCM_CH_SET_A>;
...
pub type SWAP_LR_R = crate::BitReader;
...
pub type SWAP_LR_W<'a, const O: u8> = crate::BitWriter<'a, MODE_CTL_SPEC, O>;
...
pub type S_CYCLES_R = crate::FieldReader<S_CYCLES_A>;
...
impl crate::FieldSpec for S_CYCLES_A {
    type Ux = u8;
}
impl S_CYCLES_R {
    #[doc = "Get enumerated values variant"]
...
pub type S_CYCLES_W<'a, const O: u8> = crate::FieldWriterSafe<'a, MODE_CTL_SPEC, 3, O, S_CYCLES_A>;
...
pub type CKO_DELAY_R = crate::FieldReader<CKO_DELAY_A>;
...
impl crate::FieldSpec for CKO_DELAY_A {
    type Ux = u8;
}
impl CKO_DELAY_R {
    #[doc = "Get enumerated values variant"]
...
pub type CKO_DELAY_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, MODE_CTL_SPEC, 3, O, CKO_DELAY_A>;
...
pub type HPF_GAIN_R = crate::FieldReader;
#[doc = "Field `HPF_GAIN` writer - Adjust high pass filter coefficients. H(Z) = (1 - Z-1 ) / \\[1 - (1- 2 -HPF_GAIN) Z-1 \\]
(Note: These bits are connected to AR36U12.PDM_CORE_CFG.HPGAIN)"]
pub type HPF_GAIN_W<'a, const O: u8> = crate::FieldWriter<'a, MODE_CTL_SPEC, 4, O>;
...
pub type HPF_EN_N_R = crate::BitReader;
...
pub type HPF_EN_N_W<'a, const O: u8> = crate::BitWriter<'a, MODE_CTL_SPEC, O>;
impl R {
...
impl crate::Resettable for MODE_CTL_SPEC {
    const RESET_VALUE: Self::Ux = 0x1b00_0103;
}
