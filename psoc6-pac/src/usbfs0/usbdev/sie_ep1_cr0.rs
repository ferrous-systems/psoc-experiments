...
pub type MODE_W<'a, const O: u8> = crate::FieldWriter<'a, SIE_EP1_CR0_SPEC, 4, O, MODE_A>;
...
pub type ACKED_TXN_W<'a, const O: u8> = crate::BitWriter<'a, SIE_EP1_CR0_SPEC, O, ACKED_TXN_A>;
...
pub type NAK_INT_EN_W<'a, const O: u8> = crate::BitWriter<'a, SIE_EP1_CR0_SPEC, O>;
...
pub type ERR_IN_TXN_W<'a, const O: u8> = crate::BitWriter<'a, SIE_EP1_CR0_SPEC, O>;
...
pub type STALL_W<'a, const O: u8> = crate::BitWriter<'a, SIE_EP1_CR0_SPEC, O>;
impl R {
