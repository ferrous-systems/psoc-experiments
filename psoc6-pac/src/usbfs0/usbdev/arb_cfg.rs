...
pub type AUTO_MEM_W<'a, const O: u8> = crate::BitWriter<'a, ARB_CFG_SPEC, O>;
...
pub type DMA_CFG_W<'a, const O: u8> = crate::FieldWriter<'a, ARB_CFG_SPEC, 2, O, DMA_CFG_A>;
...
pub type CFG_CMP_W<'a, const O: u8> = crate::BitWriter<'a, ARB_CFG_SPEC, O>;
impl R {
