...
pub type IN_DATA_RDY_W<'a, const O: u8> = crate::BitWriter<'a, ARB_EP8_CFG_SPEC, O>;
...
pub type DMA_REQ_W<'a, const O: u8> = crate::BitWriter<'a, ARB_EP8_CFG_SPEC, O>;
...
pub type CRC_BYPASS_W<'a, const O: u8> = crate::BitWriter<'a, ARB_EP8_CFG_SPEC, O, CRC_BYPASS_A>;
...
pub type RESET_PTR_W<'a, const O: u8> = crate::BitWriter<'a, ARB_EP8_CFG_SPEC, O, RESET_PTR_A>;
