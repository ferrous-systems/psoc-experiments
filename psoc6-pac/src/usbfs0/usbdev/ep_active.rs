...
pub type EP1_ACT_W<'a, const O: u8> = crate::BitWriter<'a, EP_ACTIVE_SPEC, O>;
...
pub type EP2_ACT_W<'a, const O: u8> = crate::BitWriter<'a, EP_ACTIVE_SPEC, O>;
...
pub type EP3_ACT_W<'a, const O: u8> = crate::BitWriter<'a, EP_ACTIVE_SPEC, O>;
...
pub type EP4_ACT_W<'a, const O: u8> = crate::BitWriter<'a, EP_ACTIVE_SPEC, O>;
...
pub type EP5_ACT_W<'a, const O: u8> = crate::BitWriter<'a, EP_ACTIVE_SPEC, O>;
...
pub type EP6_ACT_W<'a, const O: u8> = crate::BitWriter<'a, EP_ACTIVE_SPEC, O>;
...
pub type EP7_ACT_W<'a, const O: u8> = crate::BitWriter<'a, EP_ACTIVE_SPEC, O>;
...
pub type EP8_ACT_W<'a, const O: u8> = crate::BitWriter<'a, EP_ACTIVE_SPEC, O>;
impl R {
