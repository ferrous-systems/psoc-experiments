...
pub type TD_W<'a, const O: u8> = crate::BitWriter<'a, USBIO_CR0_SPEC, O, TD_A>;
...
pub type TSE0_W<'a, const O: u8> = crate::BitWriter<'a, USBIO_CR0_SPEC, O>;
...
pub type TEN_W<'a, const O: u8> = crate::BitWriter<'a, USBIO_CR0_SPEC, O>;
impl R {
