...
pub type DYN_CONFIG_EN_W<'a, const O: u8> = crate::BitWriter<'a, DYN_RECONFIG_SPEC, O>;
...
pub type DYN_RECONFIG_EPNO_W<'a, const O: u8> = crate::FieldWriter<'a, DYN_RECONFIG_SPEC, 3, O>;
