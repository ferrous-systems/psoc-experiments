...
pub type IN_BUF_FULL_W<'a, const O: u8> = crate::BitWriter<'a, ARB_EP6_SR_SPEC, O>;
...
pub type DMA_GNT_W<'a, const O: u8> = crate::BitWriter<'a, ARB_EP6_SR_SPEC, O>;
...
pub type BUF_OVER_W<'a, const O: u8> = crate::BitWriter<'a, ARB_EP6_SR_SPEC, O>;
...
pub type BUF_UNDER_W<'a, const O: u8> = crate::BitWriter<'a, ARB_EP6_SR_SPEC, O>;
...
pub type DMA_TERMIN_W<'a, const O: u8> = crate::BitWriter<'a, ARB_EP6_SR_SPEC, O>;
impl R {
