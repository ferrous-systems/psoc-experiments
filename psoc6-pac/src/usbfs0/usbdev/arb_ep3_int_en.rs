...
pub type IN_BUF_FULL_EN_W<'a, const O: u8> = crate::BitWriter<'a, ARB_EP3_INT_EN_SPEC, O>;
...
pub type DMA_GNT_EN_W<'a, const O: u8> = crate::BitWriter<'a, ARB_EP3_INT_EN_SPEC, O>;
...
pub type BUF_OVER_EN_W<'a, const O: u8> = crate::BitWriter<'a, ARB_EP3_INT_EN_SPEC, O>;
...
pub type BUF_UNDER_EN_W<'a, const O: u8> = crate::BitWriter<'a, ARB_EP3_INT_EN_SPEC, O>;
...
pub type ERR_INT_EN_W<'a, const O: u8> = crate::BitWriter<'a, ARB_EP3_INT_EN_SPEC, O>;
...
pub type DMA_TERMIN_EN_W<'a, const O: u8> = crate::BitWriter<'a, ARB_EP3_INT_EN_SPEC, O>;
impl R {
