...
pub type REG_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
...
pub type ENABLE_LOCK_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
...
pub type BUS_ACTIVITY_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
#[doc = "Field `RSVD_3` reader - N/A"]
pub type RSVD_3_R = crate::BitReader;
#[doc = "Field `RSVD_3` writer - N/A"]
pub type RSVD_3_W<'a, const O: u8> = crate::BitWriter<'a, CR1_SPEC, O>;
impl R {
