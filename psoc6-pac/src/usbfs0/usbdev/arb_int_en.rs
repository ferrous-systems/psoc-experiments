...
pub type EP1_INTR_EN_W<'a, const O: u8> = crate::BitWriter<'a, ARB_INT_EN_SPEC, O>;
...
pub type EP2_INTR_EN_W<'a, const O: u8> = crate::BitWriter<'a, ARB_INT_EN_SPEC, O>;
...
pub type EP3_INTR_EN_W<'a, const O: u8> = crate::BitWriter<'a, ARB_INT_EN_SPEC, O>;
...
pub type EP4_INTR_EN_W<'a, const O: u8> = crate::BitWriter<'a, ARB_INT_EN_SPEC, O>;
...
pub type EP5_INTR_EN_W<'a, const O: u8> = crate::BitWriter<'a, ARB_INT_EN_SPEC, O>;
...
pub type EP6_INTR_EN_W<'a, const O: u8> = crate::BitWriter<'a, ARB_INT_EN_SPEC, O>;
...
pub type EP7_INTR_EN_W<'a, const O: u8> = crate::BitWriter<'a, ARB_INT_EN_SPEC, O>;
...
pub type EP8_INTR_EN_W<'a, const O: u8> = crate::BitWriter<'a, ARB_INT_EN_SPEC, O>;
impl R {
