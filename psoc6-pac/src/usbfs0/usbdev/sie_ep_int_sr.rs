...
pub type EP1_INTR_W<'a, const O: u8> = crate::BitWriter<'a, SIE_EP_INT_SR_SPEC, O>;
...
pub type EP2_INTR_W<'a, const O: u8> = crate::BitWriter<'a, SIE_EP_INT_SR_SPEC, O>;
...
pub type EP3_INTR_W<'a, const O: u8> = crate::BitWriter<'a, SIE_EP_INT_SR_SPEC, O>;
...
pub type EP4_INTR_W<'a, const O: u8> = crate::BitWriter<'a, SIE_EP_INT_SR_SPEC, O>;
...
pub type EP5_INTR_W<'a, const O: u8> = crate::BitWriter<'a, SIE_EP_INT_SR_SPEC, O>;
...
pub type EP6_INTR_W<'a, const O: u8> = crate::BitWriter<'a, SIE_EP_INT_SR_SPEC, O>;
...
pub type EP7_INTR_W<'a, const O: u8> = crate::BitWriter<'a, SIE_EP_INT_SR_SPEC, O>;
...
pub type EP8_INTR_W<'a, const O: u8> = crate::BitWriter<'a, SIE_EP_INT_SR_SPEC, O>;
impl R {
