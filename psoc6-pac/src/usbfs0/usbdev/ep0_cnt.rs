...
pub type BYTE_COUNT_W<'a, const O: u8> = crate::FieldWriter<'a, EP0_CNT_SPEC, 4, O>;
...
pub type DATA_VALID_W<'a, const O: u8> = crate::BitWriter<'a, EP0_CNT_SPEC, O, DATA_VALID_A>;
...
pub type DATA_TOGGLE_W<'a, const O: u8> = crate::BitWriter<'a, EP0_CNT_SPEC, O>;
impl R {
