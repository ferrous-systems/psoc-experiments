...
bits of the CNT1 register. Refer to the CNT1 register for more information."]
pub type DATA_COUNT_MSB_W<'a, const O: u8> = crate::FieldWriter<'a, SIE_EP2_CNT0_SPEC, 3, O>;
...
pub type DATA_VALID_W<'a, const O: u8> = crate::BitWriter<'a, SIE_EP2_CNT0_SPEC, O, DATA_VALID_A>;
...
pub type DATA_TOGGLE_W<'a, const O: u8> = crate::BitWriter<'a, SIE_EP2_CNT0_SPEC, O>;
impl R {
