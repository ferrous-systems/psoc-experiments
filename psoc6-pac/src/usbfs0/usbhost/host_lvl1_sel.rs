...
pub type SOFIRQ_SEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, HOST_LVL1_SEL_SPEC, 2, O, SOFIRQ_SEL_A>;
...
pub type DIRQ_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, HOST_LVL1_SEL_SPEC, 2, O>;
...
pub type CNNIRQ_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, HOST_LVL1_SEL_SPEC, 2, O>;
...
pub type CMPIRQ_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, HOST_LVL1_SEL_SPEC, 2, O>;
...
pub type URIRQ_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, HOST_LVL1_SEL_SPEC, 2, O>;
...
pub type RWKIRQ_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, HOST_LVL1_SEL_SPEC, 2, O>;
#[doc = "Field `RSVD_13_12` reader - N/A"]
pub type RSVD_13_12_R = crate::FieldReader;
#[doc = "Field `RSVD_13_12` writer - N/A"]
pub type RSVD_13_12_W<'a, const O: u8> = crate::FieldWriter<'a, HOST_LVL1_SEL_SPEC, 2, O>;
...
pub type TCAN_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, HOST_LVL1_SEL_SPEC, 2, O>;
impl R {
