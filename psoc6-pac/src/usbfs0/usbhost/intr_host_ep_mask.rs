...
pub type EP1DRQM_W<'a, const O: u8> = crate::BitWriter<'a, INTR_HOST_EP_MASK_SPEC, O>;
...
pub type EP1SPKM_W<'a, const O: u8> = crate::BitWriter<'a, INTR_HOST_EP_MASK_SPEC, O>;
...
pub type EP2DRQM_W<'a, const O: u8> = crate::BitWriter<'a, INTR_HOST_EP_MASK_SPEC, O>;
...
pub type EP2SPKM_W<'a, const O: u8> = crate::BitWriter<'a, INTR_HOST_EP_MASK_SPEC, O>;
impl R {
