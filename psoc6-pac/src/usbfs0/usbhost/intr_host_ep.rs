...
pub type EP1DRQ_W<'a, const O: u8> = crate::BitWriter<'a, INTR_HOST_EP_SPEC, O>;
...
pub type EP1SPK_W<'a, const O: u8> = crate::BitWriter<'a, INTR_HOST_EP_SPEC, O>;
...
pub type EP2DRQ_W<'a, const O: u8> = crate::BitWriter<'a, INTR_HOST_EP_SPEC, O>;
...
pub type EP2SPK_W<'a, const O: u8> = crate::BitWriter<'a, INTR_HOST_EP_SPEC, O>;
impl R {
