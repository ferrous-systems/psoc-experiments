...
pub type EP1DRQS_W<'a, const O: u8> = crate::BitWriter<'a, INTR_HOST_EP_SET_SPEC, O>;
...
pub type EP1SPKS_W<'a, const O: u8> = crate::BitWriter<'a, INTR_HOST_EP_SET_SPEC, O>;
...
pub type EP2DRQS_W<'a, const O: u8> = crate::BitWriter<'a, INTR_HOST_EP_SET_SPEC, O>;
...
pub type EP2SPKS_W<'a, const O: u8> = crate::BitWriter<'a, INTR_HOST_EP_SET_SPEC, O>;
impl R {
