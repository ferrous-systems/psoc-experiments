...
pub type ENDPT_W<'a, const O: u8> = crate::FieldWriter<'a, HOST_TOKEN_SPEC, 4, O>;
...
pub type TKNEN_W<'a, const O: u8> = crate::FieldWriterSafe<'a, HOST_TOKEN_SPEC, 3, O, TKNEN_A>;
...
pub type TGGL_W<'a, const O: u8> = crate::BitWriter<'a, HOST_TOKEN_SPEC, O>;
impl R {
