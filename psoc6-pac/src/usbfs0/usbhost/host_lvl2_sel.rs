...
pub type EP1_DRQ_SEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, HOST_LVL2_SEL_SPEC, 2, O, EP1_DRQ_SEL_A>;
...
pub type EP1_SPK_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, HOST_LVL2_SEL_SPEC, 2, O>;
...
pub type EP2_DRQ_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, HOST_LVL2_SEL_SPEC, 2, O>;
...
pub type EP2_SPK_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, HOST_LVL2_SEL_SPEC, 2, O>;
impl R {
