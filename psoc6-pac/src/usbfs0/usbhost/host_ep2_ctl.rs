...
pub type PKS2_R = crate::FieldReader;
...
pub type PKS2_W<'a, const O: u8> = crate::FieldWriter<'a, HOST_EP2_CTL_SPEC, 7, O>;
...
pub type NULLE_W<'a, const O: u8> = crate::BitWriter<'a, HOST_EP2_CTL_SPEC, O>;
...
pub type DMAE_W<'a, const O: u8> = crate::BitWriter<'a, HOST_EP2_CTL_SPEC, O>;
...
pub type DIR_W<'a, const O: u8> = crate::BitWriter<'a, HOST_EP2_CTL_SPEC, O>;
...
pub type BFINI_W<'a, const O: u8> = crate::BitWriter<'a, HOST_EP2_CTL_SPEC, O>;
impl R {
...
impl crate::Resettable for HOST_EP2_CTL_SPEC {
    const RESET_VALUE: Self::Ux = 0x8040;
}
