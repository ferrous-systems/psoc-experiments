...
pub type SOFIRQS_W<'a, const O: u8> = crate::BitWriter<'a, INTR_USBHOST_SET_SPEC, O>;
...
pub type DIRQS_W<'a, const O: u8> = crate::BitWriter<'a, INTR_USBHOST_SET_SPEC, O>;
...
pub type CNNIRQS_W<'a, const O: u8> = crate::BitWriter<'a, INTR_USBHOST_SET_SPEC, O>;
...
pub type CMPIRQS_W<'a, const O: u8> = crate::BitWriter<'a, INTR_USBHOST_SET_SPEC, O>;
...
pub type URIRQS_W<'a, const O: u8> = crate::BitWriter<'a, INTR_USBHOST_SET_SPEC, O>;
...
pub type RWKIRQS_W<'a, const O: u8> = crate::BitWriter<'a, INTR_USBHOST_SET_SPEC, O>;
#[doc = "Field `RSVD_6` reader - N/A"]
pub type RSVD_6_R = crate::BitReader;
#[doc = "Field `RSVD_6` writer - N/A"]
pub type RSVD_6_W<'a, const O: u8> = crate::BitWriter<'a, INTR_USBHOST_SET_SPEC, O>;
...
pub type TCANS_W<'a, const O: u8> = crate::BitWriter<'a, INTR_USBHOST_SET_SPEC, O>;
impl R {
