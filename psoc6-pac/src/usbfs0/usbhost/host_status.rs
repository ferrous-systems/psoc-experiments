...
pub type SUSP_W<'a, const O: u8> = crate::BitWriter<'a, HOST_STATUS_SPEC, O>;
...
pub type SOFBUSY_W<'a, const O: u8> = crate::BitWriter<'a, HOST_STATUS_SPEC, O>;
...
pub type URST_W<'a, const O: u8> = crate::BitWriter<'a, HOST_STATUS_SPEC, O>;
