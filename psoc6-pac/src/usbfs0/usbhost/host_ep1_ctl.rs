...
pub type PKS1_W<'a, const O: u8> = crate::FieldWriter<'a, HOST_EP1_CTL_SPEC, 9, O, u16>;
...
pub type NULLE_W<'a, const O: u8> = crate::BitWriter<'a, HOST_EP1_CTL_SPEC, O>;
...
pub type DMAE_W<'a, const O: u8> = crate::BitWriter<'a, HOST_EP1_CTL_SPEC, O>;
...
pub type DIR_W<'a, const O: u8> = crate::BitWriter<'a, HOST_EP1_CTL_SPEC, O>;
...
pub type BFINI_W<'a, const O: u8> = crate::BitWriter<'a, HOST_EP1_CTL_SPEC, O>;
impl R {
