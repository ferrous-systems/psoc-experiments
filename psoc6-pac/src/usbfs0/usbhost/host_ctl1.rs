...
pub type CLKSEL_W<'a, const O: u8> = crate::BitWriter<'a, HOST_CTL1_SPEC, O>;
...
pub type USTP_W<'a, const O: u8> = crate::BitWriter<'a, HOST_CTL1_SPEC, O>;
...
pub type RST_W<'a, const O: u8> = crate::BitWriter<'a, HOST_CTL1_SPEC, O>;
impl R {
