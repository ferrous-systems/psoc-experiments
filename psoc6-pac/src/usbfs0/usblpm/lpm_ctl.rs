...
pub type LPM_EN_W<'a, const O: u8> = crate::BitWriter<'a, LPM_CTL_SPEC, O>;
...
pub type LPM_ACK_RESP_W<'a, const O: u8> = crate::BitWriter<'a, LPM_CTL_SPEC, O>;
...
pub type NYET_EN_W<'a, const O: u8> = crate::BitWriter<'a, LPM_CTL_SPEC, O>;
...
pub type SUB_RESP_W<'a, const O: u8> = crate::BitWriter<'a, LPM_CTL_SPEC, O>;
impl R {
