...
pub type SOF_LVL_SEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, INTR_LVL_SEL_SPEC, 2, O, SOF_LVL_SEL_A>;
...
pub type BUS_RESET_LVL_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, INTR_LVL_SEL_SPEC, 2, O>;
...
pub type EP0_LVL_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, INTR_LVL_SEL_SPEC, 2, O>;
...
pub type LPM_LVL_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, INTR_LVL_SEL_SPEC, 2, O>;
...
pub type RESUME_LVL_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, INTR_LVL_SEL_SPEC, 2, O>;
...
pub type ARB_EP_LVL_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, INTR_LVL_SEL_SPEC, 2, O>;
...
pub type EP1_LVL_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, INTR_LVL_SEL_SPEC, 2, O>;
...
pub type EP2_LVL_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, INTR_LVL_SEL_SPEC, 2, O>;
...
pub type EP3_LVL_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, INTR_LVL_SEL_SPEC, 2, O>;
...
pub type EP4_LVL_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, INTR_LVL_SEL_SPEC, 2, O>;
...
pub type EP5_LVL_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, INTR_LVL_SEL_SPEC, 2, O>;
...
pub type EP6_LVL_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, INTR_LVL_SEL_SPEC, 2, O>;
...
pub type EP7_LVL_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, INTR_LVL_SEL_SPEC, 2, O>;
...
pub type EP8_LVL_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, INTR_LVL_SEL_SPEC, 2, O>;
impl R {
