...
pub type SOF_INTR_SET_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SIE_SET_SPEC, O>;
...
pub type BUS_RESET_INTR_SET_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SIE_SET_SPEC, O>;
...
pub type EP0_INTR_SET_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SIE_SET_SPEC, O>;
...
pub type LPM_INTR_SET_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SIE_SET_SPEC, O>;
...
pub type RESUME_INTR_SET_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SIE_SET_SPEC, O>;
impl R {
