...
pub type EP1_ERR_RESP_W<'a, const O: u8> = crate::BitWriter<'a, FLOW_CTL_SPEC, O>;
...
pub type EP2_ERR_RESP_W<'a, const O: u8> = crate::BitWriter<'a, FLOW_CTL_SPEC, O>;
...
pub type EP3_ERR_RESP_W<'a, const O: u8> = crate::BitWriter<'a, FLOW_CTL_SPEC, O>;
...
pub type EP4_ERR_RESP_W<'a, const O: u8> = crate::BitWriter<'a, FLOW_CTL_SPEC, O>;
...
pub type EP5_ERR_RESP_W<'a, const O: u8> = crate::BitWriter<'a, FLOW_CTL_SPEC, O>;
...
pub type EP6_ERR_RESP_W<'a, const O: u8> = crate::BitWriter<'a, FLOW_CTL_SPEC, O>;
...
pub type EP7_ERR_RESP_W<'a, const O: u8> = crate::BitWriter<'a, FLOW_CTL_SPEC, O>;
...
pub type EP8_ERR_RESP_W<'a, const O: u8> = crate::BitWriter<'a, FLOW_CTL_SPEC, O>;
impl R {
