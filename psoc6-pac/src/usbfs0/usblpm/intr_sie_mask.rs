...
pub type SOF_INTR_MASK_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SIE_MASK_SPEC, O>;
...
pub type BUS_RESET_INTR_MASK_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SIE_MASK_SPEC, O>;
...
pub type EP0_INTR_MASK_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SIE_MASK_SPEC, O>;
...
pub type LPM_INTR_MASK_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SIE_MASK_SPEC, O>;
...
pub type RESUME_INTR_MASK_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SIE_MASK_SPEC, O>;
impl R {
