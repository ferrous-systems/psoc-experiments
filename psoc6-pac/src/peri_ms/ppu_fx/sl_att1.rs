...
pub struct R(crate::R<SL_ATT1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SL_ATT1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SL_ATT1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SL_ATT1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SL_ATT1` writer"]
pub struct W(crate::W<SL_ATT1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SL_ATT1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SL_ATT1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SL_ATT1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PC4_UR_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT1_SPEC, O>;
...
pub type PC4_UW_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT1_SPEC, O>;
...
pub type PC4_PR_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT1_SPEC, O>;
...
pub type PC4_PW_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT1_SPEC, O>;
...
pub type PC4_NS_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT1_SPEC, O>;
...
pub type PC5_UR_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT1_SPEC, O>;
...
pub type PC5_UW_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT1_SPEC, O>;
...
pub type PC5_PR_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT1_SPEC, O>;
...
pub type PC5_PW_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT1_SPEC, O>;
...
pub type PC5_NS_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT1_SPEC, O>;
...
pub type PC6_UR_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT1_SPEC, O>;
...
pub type PC6_UW_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT1_SPEC, O>;
...
pub type PC6_PR_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT1_SPEC, O>;
...
pub type PC6_PW_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT1_SPEC, O>;
...
pub type PC6_NS_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT1_SPEC, O>;
...
pub type PC7_UR_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT1_SPEC, O>;
...
pub type PC7_UW_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT1_SPEC, O>;
...
pub type PC7_PR_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT1_SPEC, O>;
...
pub type PC7_PW_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT1_SPEC, O>;
...
pub type PC7_NS_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT1_SPEC, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc4_ur(&mut self) -> PC4_UR_W<0> {
        PC4_UR_W::new(self)
    }
    #[doc = "Bit 1 - Protection context 4, user write enable."]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc4_pr(&mut self) -> PC4_PR_W<2> {
        PC4_PR_W::new(self)
    }
    #[doc = "Bit 3 - Protection context 4, privileged write enable."]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc5_ur(&mut self) -> PC5_UR_W<8> {
        PC5_UR_W::new(self)
    }
    #[doc = "Bit 9 - Protection context 5, user write enable."]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc5_pr(&mut self) -> PC5_PR_W<10> {
        PC5_PR_W::new(self)
    }
    #[doc = "Bit 11 - Protection context 5, privileged write enable."]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc6_ur(&mut self) -> PC6_UR_W<16> {
        PC6_UR_W::new(self)
    }
    #[doc = "Bit 17 - Protection context 6, user write enable."]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc6_pr(&mut self) -> PC6_PR_W<18> {
        PC6_PR_W::new(self)
    }
    #[doc = "Bit 19 - Protection context 6, privileged write enable."]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc7_ur(&mut self) -> PC7_UR_W<24> {
        PC7_UR_W::new(self)
    }
    #[doc = "Bit 25 - Protection context 7, user write enable."]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc7_pr(&mut self) -> PC7_PR_W<26> {
        PC7_PR_W::new(self)
    }
    #[doc = "Bit 27 - Protection context 7, privileged write enable."]
    #[inline(always)]
...
#[doc = "Slave attributes 1\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sl_att1](index.html) module"]
pub struct SL_ATT1_SPEC;
impl crate::RegisterSpec for SL_ATT1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sl_att1::R](R) reader structure"]
impl crate::Readable for SL_ATT1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sl_att1::W](W) writer structure"]
impl crate::Writable for SL_ATT1_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SL_ATT1 to value 0x1f1f_1f1f"]
impl crate::Resettable for SL_ATT1_SPEC {
