...
pub struct R(crate::R<SL_ATT2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SL_ATT2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SL_ATT2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SL_ATT2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SL_ATT2` writer"]
pub struct W(crate::W<SL_ATT2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SL_ATT2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SL_ATT2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SL_ATT2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PC8_UR_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT2_SPEC, O>;
...
pub type PC8_UW_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT2_SPEC, O>;
...
pub type PC8_PR_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT2_SPEC, O>;
...
pub type PC8_PW_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT2_SPEC, O>;
...
pub type PC8_NS_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT2_SPEC, O>;
...
pub type PC9_UR_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT2_SPEC, O>;
...
pub type PC9_UW_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT2_SPEC, O>;
...
pub type PC9_PR_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT2_SPEC, O>;
...
pub type PC9_PW_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT2_SPEC, O>;
...
pub type PC9_NS_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT2_SPEC, O>;
...
pub type PC10_UR_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT2_SPEC, O>;
...
pub type PC10_UW_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT2_SPEC, O>;
...
pub type PC10_PR_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT2_SPEC, O>;
...
pub type PC10_PW_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT2_SPEC, O>;
...
pub type PC10_NS_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT2_SPEC, O>;
...
pub type PC11_UR_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT2_SPEC, O>;
...
pub type PC11_UW_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT2_SPEC, O>;
...
pub type PC11_PR_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT2_SPEC, O>;
...
pub type PC11_PW_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT2_SPEC, O>;
...
pub type PC11_NS_W<'a, const O: u8> = crate::BitWriter<'a, SL_ATT2_SPEC, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc8_ur(&mut self) -> PC8_UR_W<0> {
        PC8_UR_W::new(self)
    }
    #[doc = "Bit 1 - Protection context 8, user write enable."]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc8_pr(&mut self) -> PC8_PR_W<2> {
        PC8_PR_W::new(self)
    }
    #[doc = "Bit 3 - Protection context 8, privileged write enable."]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc9_ur(&mut self) -> PC9_UR_W<8> {
        PC9_UR_W::new(self)
    }
    #[doc = "Bit 9 - Protection context 9, user write enable."]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc9_pr(&mut self) -> PC9_PR_W<10> {
        PC9_PR_W::new(self)
    }
    #[doc = "Bit 11 - Protection context 9, privileged write enable."]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc10_ur(&mut self) -> PC10_UR_W<16> {
        PC10_UR_W::new(self)
    }
    #[doc = "Bit 17 - Protection context 10, user write enable."]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc10_pr(&mut self) -> PC10_PR_W<18> {
        PC10_PR_W::new(self)
    }
    #[doc = "Bit 19 - Protection context 10, privileged write enable."]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc11_ur(&mut self) -> PC11_UR_W<24> {
        PC11_UR_W::new(self)
    }
    #[doc = "Bit 25 - Protection context 11, user write enable."]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc11_pr(&mut self) -> PC11_PR_W<26> {
        PC11_PR_W::new(self)
    }
    #[doc = "Bit 27 - Protection context 11, privileged write enable."]
    #[inline(always)]
...
#[doc = "Slave attributes 2\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sl_att2](index.html) module"]
pub struct SL_ATT2_SPEC;
impl crate::RegisterSpec for SL_ATT2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [sl_att2::R](R) reader structure"]
impl crate::Readable for SL_ATT2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sl_att2::W](W) writer structure"]
impl crate::Writable for SL_ATT2_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SL_ATT2 to value 0x1f1f_1f1f"]
impl crate::Resettable for SL_ATT2_SPEC {
