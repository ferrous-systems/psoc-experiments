...
pub struct R(crate::R<MONITOR_CTL_2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MONITOR_CTL_2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MONITOR_CTL_2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MONITOR_CTL_2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MONITOR_CTL_2` writer"]
pub struct W(crate::W<MONITOR_CTL_2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MONITOR_CTL_2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MONITOR_CTL_2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MONITOR_CTL_2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MONITOR_EN_W<'a, const O: u8> = crate::FieldWriter<'a, MONITOR_CTL_2_SPEC, 32, O, u32>;
impl R {
