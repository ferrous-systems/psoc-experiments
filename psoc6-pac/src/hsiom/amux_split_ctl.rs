...
pub type SWITCH_AA_SL_W<'a, const O: u8> = crate::BitWriter<'a, AMUX_SPLIT_CTL_SPEC, O>;
...
pub type SWITCH_AA_SR_W<'a, const O: u8> = crate::BitWriter<'a, AMUX_SPLIT_CTL_SPEC, O>;
...
pub type SWITCH_AA_S0_W<'a, const O: u8> = crate::BitWriter<'a, AMUX_SPLIT_CTL_SPEC, O>;
...
pub type SWITCH_BB_SL_W<'a, const O: u8> = crate::BitWriter<'a, AMUX_SPLIT_CTL_SPEC, O>;
...
pub type SWITCH_BB_SR_W<'a, const O: u8> = crate::BitWriter<'a, AMUX_SPLIT_CTL_SPEC, O>;
...
pub type SWITCH_BB_S0_W<'a, const O: u8> = crate::BitWriter<'a, AMUX_SPLIT_CTL_SPEC, O>;
impl R {
