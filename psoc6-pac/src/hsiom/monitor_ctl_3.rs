...
pub struct R(crate::R<MONITOR_CTL_3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MONITOR_CTL_3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MONITOR_CTL_3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MONITOR_CTL_3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MONITOR_CTL_3` writer"]
pub struct W(crate::W<MONITOR_CTL_3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MONITOR_CTL_3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MONITOR_CTL_3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MONITOR_CTL_3_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MONITOR_EN_W<'a, const O: u8> = crate::FieldWriter<'a, MONITOR_CTL_3_SPEC, 32, O, u32>;
impl R {
...
#[doc = "Power/Ground Monitor cell control 3\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [monitor_ctl_3](index.html) module"]
pub struct MONITOR_CTL_3_SPEC;
impl crate::RegisterSpec for MONITOR_CTL_3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [monitor_ctl_3::R](R) reader structure"]
impl crate::Readable for MONITOR_CTL_3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [monitor_ctl_3::W](W) writer structure"]
impl crate::Writable for MONITOR_CTL_3_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets MONITOR_CTL_3 to value 0"]
impl crate::Resettable for MONITOR_CTL_3_SPEC {
