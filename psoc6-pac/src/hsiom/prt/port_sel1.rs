...
pub type IO4_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, PORT_SEL1_SPEC, 5, O>;
...
pub type IO5_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, PORT_SEL1_SPEC, 5, O>;
...
pub type IO6_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, PORT_SEL1_SPEC, 5, O>;
...
pub type IO7_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, PORT_SEL1_SPEC, 5, O>;
impl R {
