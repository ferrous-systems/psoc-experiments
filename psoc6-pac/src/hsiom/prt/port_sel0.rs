...
pub type IO0_SEL_R = crate::FieldReader<IO0_SEL_A>;
...
impl crate::FieldSpec for IO0_SEL_A {
    type Ux = u8;
}
impl IO0_SEL_R {
...
pub type IO0_SEL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, PORT_SEL0_SPEC, 5, O, IO0_SEL_A>;
...
pub type IO1_SEL_R = crate::FieldReader;
#[doc = "Field `IO1_SEL` writer - Selects connection for IO pin 1 route."]
pub type IO1_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, PORT_SEL0_SPEC, 5, O>;
#[doc = "Field `IO2_SEL` reader - Selects connection for IO pin 2 route."]
pub type IO2_SEL_R = crate::FieldReader;
#[doc = "Field `IO2_SEL` writer - Selects connection for IO pin 2 route."]
pub type IO2_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, PORT_SEL0_SPEC, 5, O>;
#[doc = "Field `IO3_SEL` reader - Selects connection for IO pin 3 route."]
pub type IO3_SEL_R = crate::FieldReader;
#[doc = "Field `IO3_SEL` writer - Selects connection for IO pin 3 route."]
pub type IO3_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, PORT_SEL0_SPEC, 5, O>;
impl R {
