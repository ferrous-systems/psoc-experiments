...
pub mod ctrl;
#[doc = "SAMPLE_CTRL (rw) register accessor: an alias for `Reg<SAMPLE_CTRL_SPEC>`"]
pub type SAMPLE_CTRL = crate::Reg<sample_ctrl::SAMPLE_CTRL_SPEC>;
#[doc = "Sample control register."]
pub mod sample_ctrl;
#[doc = "SAMPLE_TIME01 (rw) register accessor: an alias for `Reg<SAMPLE_TIME01_SPEC>`"]
...
#[doc = "SAMPLE_TIME23 (rw) register accessor: an alias for `Reg<SAMPLE_TIME23_SPEC>`"]
...
#[doc = "CHAN_RESULT_UPDATED (r) register accessor: an alias for `Reg<CHAN_RESULT_UPDATED_SPEC>`"]
...
#[doc = "CHAN_WORK_NEWVALUE (r) register accessor: an alias for `Reg<CHAN_WORK_NEWVALUE_SPEC>`"]
...
#[doc = "CHAN_RESULT_NEWVALUE (r) register accessor: an alias for `Reg<CHAN_RESULT_NEWVALUE_SPEC>`"]
...
pub mod intr_masked;
#[doc = "SATURATE_INTR (rw) register accessor: an alias for `Reg<SATURATE_INTR_SPEC>`"]
...
#[doc = "SATURATE_INTR_SET (rw) register accessor: an alias for `Reg<SATURATE_INTR_SET_SPEC>`"]
...
#[doc = "SATURATE_INTR_MASK (rw) register accessor: an alias for `Reg<SATURATE_INTR_MASK_SPEC>`"]
...
#[doc = "SATURATE_INTR_MASKED (r) register accessor: an alias for `Reg<SATURATE_INTR_MASKED_SPEC>`"]
...
#[doc = "RANGE_INTR (rw) register accessor: an alias for `Reg<RANGE_INTR_SPEC>`"]
pub type RANGE_INTR = crate::Reg<range_intr::RANGE_INTR_SPEC>;
#[doc = "Range detect interrupt request register."]
pub mod range_intr;
#[doc = "RANGE_INTR_SET (rw) register accessor: an alias for `Reg<RANGE_INTR_SET_SPEC>`"]
...
#[doc = "RANGE_INTR_MASK (rw) register accessor: an alias for `Reg<RANGE_INTR_MASK_SPEC>`"]
...
#[doc = "RANGE_INTR_MASKED (r) register accessor: an alias for `Reg<RANGE_INTR_MASKED_SPEC>`"]
...
pub mod intr_cause;
#[doc = "INJ_CHAN_CONFIG (rw) register accessor: an alias for `Reg<INJ_CHAN_CONFIG_SPEC>`"]
...
#[doc = "INJ_RESULT (r) register accessor: an alias for `Reg<INJ_RESULT_SPEC>`"]
...
pub mod avg_stat;
#[doc = "MUX_SWITCH0 (rw) register accessor: an alias for `Reg<MUX_SWITCH0_SPEC>`"]
pub type MUX_SWITCH0 = crate::Reg<mux_switch0::MUX_SWITCH0_SPEC>;
#[doc = "SARMUX Firmware switch controls"]
pub mod mux_switch0;
#[doc = "MUX_SWITCH_CLEAR0 (rw) register accessor: an alias for `Reg<MUX_SWITCH_CLEAR0_SPEC>`"]
...
#[doc = "MUX_SWITCH_DS_CTRL (rw) register accessor: an alias for `Reg<MUX_SWITCH_DS_CTRL_SPEC>`"]
...
#[doc = "MUX_SWITCH_SQ_CTRL (rw) register accessor: an alias for `Reg<MUX_SWITCH_SQ_CTRL_SPEC>`"]
...
#[doc = "MUX_SWITCH_STATUS (r) register accessor: an alias for `Reg<MUX_SWITCH_STATUS_SPEC>`"]
...
#[doc = "ANA_TRIM0 (rw) register accessor: an alias for `Reg<ANA_TRIM0_SPEC>`"]
pub type ANA_TRIM0 = crate::Reg<ana_trim0::ANA_TRIM0_SPEC>;
#[doc = "Analog trim register."]
pub mod ana_trim0;
#[doc = "ANA_TRIM1 (rw) register accessor: an alias for `Reg<ANA_TRIM1_SPEC>`"]
