...
pub type LS_EN_W<'a, const O: u8> = crate::BitWriter<'a, CONTROL_SPEC, O>;
...
pub type HS_EN_W<'a, const O: u8> = crate::BitWriter<'a, CONTROL_SPEC, O>;
...
pub type LCD_MODE_W<'a, const O: u8> = crate::BitWriter<'a, CONTROL_SPEC, O, LCD_MODE_A>;
...
pub type TYPE_W<'a, const O: u8> = crate::BitWriter<'a, CONTROL_SPEC, O, TYPE_A>;
...
pub type OP_MODE_W<'a, const O: u8> = crate::BitWriter<'a, CONTROL_SPEC, O, OP_MODE_A>;
...
pub type BIAS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CONTROL_SPEC, 2, O, BIAS_A>;
...
pub type COM_NUM_R = crate::FieldReader;
...
pub type COM_NUM_W<'a, const O: u8> = crate::FieldWriter<'a, CONTROL_SPEC, 4, O>;
...
pub type LS_EN_STAT_R = crate::BitReader;
impl R {
