...
pub type IPTAT_CORE_TRIM_W<'a, const O: u8> = crate::FieldWriter<'a, IPTAT_TRIM0_SPEC, 4, O>;
...
pub type IPTAT_CTBM_TRIM_W<'a, const O: u8> = crate::FieldWriter<'a, IPTAT_TRIM0_SPEC, 4, O>;
impl R {
