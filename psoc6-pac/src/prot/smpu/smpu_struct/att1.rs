...
pub type UW_W<'a, const O: u8> = crate::BitWriter<'a, ATT1_SPEC, O>;
...
pub type PW_W<'a, const O: u8> = crate::BitWriter<'a, ATT1_SPEC, O>;
...
pub type NS_W<'a, const O: u8> = crate::BitWriter<'a, ATT1_SPEC, O>;
...
pub type PC_MASK_15_TO_1_W<'a, const O: u8> = crate::FieldWriter<'a, ATT1_SPEC, 15, O, u16>;
...
pub type PC_MATCH_W<'a, const O: u8> = crate::BitWriter<'a, ATT1_SPEC, O>;
...
pub type ENABLED_W<'a, const O: u8> = crate::BitWriter<'a, ATT1_SPEC, O>;
impl R {
