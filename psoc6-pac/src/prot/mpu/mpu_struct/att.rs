...
pub type UR_W<'a, const O: u8> = crate::BitWriter<'a, ATT_SPEC, O>;
...
pub type UW_W<'a, const O: u8> = crate::BitWriter<'a, ATT_SPEC, O>;
...
pub type UX_W<'a, const O: u8> = crate::BitWriter<'a, ATT_SPEC, O>;
...
pub type PR_W<'a, const O: u8> = crate::BitWriter<'a, ATT_SPEC, O>;
...
pub type PW_W<'a, const O: u8> = crate::BitWriter<'a, ATT_SPEC, O>;
...
pub type PX_W<'a, const O: u8> = crate::BitWriter<'a, ATT_SPEC, O>;
...
pub type NS_W<'a, const O: u8> = crate::BitWriter<'a, ATT_SPEC, O>;
...
pub type REGION_SIZE_W<'a, const O: u8> = crate::FieldWriter<'a, ATT_SPEC, 5, O>;
...
pub type ENABLED_W<'a, const O: u8> = crate::BitWriter<'a, ATT_SPEC, O>;
impl R {
