...
pub type SAMPLE_TIME2_W<'a, const O: u8> = crate::FieldWriter<'a, SAMPLE_TIME23_SPEC, 10, O, u16>;
...
pub type SAMPLE_TIME3_W<'a, const O: u8> = crate::FieldWriter<'a, SAMPLE_TIME23_SPEC, 10, O, u16>;
impl R {
