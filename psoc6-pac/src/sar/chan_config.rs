...
pub type POS_PIN_ADDR_W<'a, const O: u8> = crate::FieldWriter<'a, CHAN_CONFIG_SPEC, 3, O>;
...
pub type POS_PORT_ADDR_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, CHAN_CONFIG_SPEC, 3, O, POS_PORT_ADDR_A>;
...
is ignored and considered to be 0, i.e. POS_PIN_ADDR points to the even pin of a pin pair. In that case the even pin of the pair is connected to Vplus and the odd pin of the pair is connected to Vminus. POS_PORT_ADDR is used to identify the port that contains the pins. - 0: The voltage on the addressed pin is measured (Single-ended) and the resulting value is stored in the corresponding data register. - 1: The differential voltage on the addressed pin pair is measured and the resulting value is stored in the corresponding data register. (if NEG_ADDR_EN=0 then POS_PIN_ADDR\\[0\\]
is ignored)."]
pub type DIFFERENTIAL_EN_W<'a, const O: u8> = crate::BitWriter<'a, CHAN_CONFIG_SPEC, O>;
...
pub type AVG_EN_W<'a, const O: u8> = crate::BitWriter<'a, CHAN_CONFIG_SPEC, O>;
...
pub type SAMPLE_TIME_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, CHAN_CONFIG_SPEC, 2, O>;
...
pub type NEG_PIN_ADDR_W<'a, const O: u8> = crate::FieldWriter<'a, CHAN_CONFIG_SPEC, 3, O>;
...
pub type NEG_PORT_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, CHAN_CONFIG_SPEC, 3, O, NEG_PORT_ADDR_A>;
...
pub type NEG_ADDR_EN_W<'a, const O: u8> = crate::BitWriter<'a, CHAN_CONFIG_SPEC, O>;
...
pub type DSI_OUT_EN_W<'a, const O: u8> = crate::BitWriter<'a, CHAN_CONFIG_SPEC, O>;
impl R {
