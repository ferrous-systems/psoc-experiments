...
pub type EOS_INTR_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPEC, O>;
...
pub type OVERFLOW_INTR_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPEC, O>;
...
pub type FW_COLLISION_INTR_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPEC, O>;
...
pub type DSI_COLLISION_INTR_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPEC, O>;
...
pub type INJ_EOC_INTR_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPEC, O>;
...
pub type INJ_SATURATE_INTR_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPEC, O>;
...
pub type INJ_RANGE_INTR_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPEC, O>;
...
pub type INJ_COLLISION_INTR_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPEC, O>;
impl R {
