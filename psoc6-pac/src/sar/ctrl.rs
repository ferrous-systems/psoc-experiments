...
pub type PWR_CTRL_VREF_R = crate::FieldReader<PWR_CTRL_VREF_A>;
...
impl crate::FieldSpec for PWR_CTRL_VREF_A {
    type Ux = u8;
}
...
pub type PWR_CTRL_VREF_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, CTRL_SPEC, 3, O, PWR_CTRL_VREF_A>;
...
pub type VREF_SEL_R = crate::FieldReader<VREF_SEL_A>;
...
impl crate::FieldSpec for VREF_SEL_A {
    type Ux = u8;
}
impl VREF_SEL_R {
    #[doc = "Get enumerated values variant"]
...
pub type VREF_SEL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CTRL_SPEC, 3, O, VREF_SEL_A>;
...
impl crate::FieldSpec for NEG_SEL_A {
    type Ux = u8;
}
impl NEG_SEL_R {
    #[doc = "Get enumerated values variant"]
...
pub type NEG_SEL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CTRL_SPEC, 3, O, NEG_SEL_A>;
...
pub type SAR_HW_CTRL_NEGVREF_R = crate::BitReader;
...
pub type SAR_HW_CTRL_NEGVREF_W<'a, const O: u8> = crate::BitWriter<'a, CTRL_SPEC, O>;
#[doc = "Field `COMP_DLY` reader - Set the comparator latch delay in accordance with SAR conversion rate"]
pub type COMP_DLY_R = crate::FieldReader<COMP_DLY_A>;
...
impl crate::FieldSpec for COMP_DLY_A {
    type Ux = u8;
}
impl COMP_DLY_R {
    #[doc = "Get enumerated values variant"]
...
pub type COMP_DLY_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CTRL_SPEC, 2, O, COMP_DLY_A>;
...
pub type SPARE_W<'a, const O: u8> = crate::FieldWriter<'a, CTRL_SPEC, 4, O>;
#[doc = "Field `BOOSTPUMP_EN` reader - deprecated"]
pub type BOOSTPUMP_EN_R = crate::BitReader;
#[doc = "Field `BOOSTPUMP_EN` writer - deprecated"]
pub type BOOSTPUMP_EN_W<'a, const O: u8> = crate::BitWriter<'a, CTRL_SPEC, O>;
...
pub type REFBUF_EN_R = crate::BitReader;
...
pub type REFBUF_EN_W<'a, const O: u8> = crate::BitWriter<'a, CTRL_SPEC, O>;
#[doc = "Field `COMP_PWR` reader - Comparator power mode."]
pub type COMP_PWR_R = crate::FieldReader<COMP_PWR_A>;
...
impl crate::FieldSpec for COMP_PWR_A {
    type Ux = u8;
}
impl COMP_PWR_R {
    #[doc = "Get enumerated values variant"]
...
pub type COMP_PWR_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CTRL_SPEC, 3, O, COMP_PWR_A>;
...
pub type DEEPSLEEP_ON_R = crate::BitReader;
...
pub type DEEPSLEEP_ON_W<'a, const O: u8> = crate::BitWriter<'a, CTRL_SPEC, O>;
...
pub type DSI_SYNC_CONFIG_R = crate::BitReader;
...
pub type DSI_SYNC_CONFIG_W<'a, const O: u8> = crate::BitWriter<'a, CTRL_SPEC, O>;
...
pub type DSI_MODE_R = crate::BitReader;
#[doc = "Field `DSI_MODE` writer - SAR sequencer takes configuration from DSI signals (note this also has the same effect as SWITCH_DISABLE==1) - 0: Normal mode, SAR sequencer operates according to CHAN_EN enables and CHAN_CONFIG channel configurations - 1: CHAN_EN, INJ_START_EN and channel configurations in CHAN_CONFIG and INJ_CHAN_CONFIG are ignored"]
pub type DSI_MODE_W<'a, const O: u8> = crate::BitWriter<'a, CTRL_SPEC, O>;
...
pub type SWITCH_DISABLE_R = crate::BitReader;
...
pub type SWITCH_DISABLE_W<'a, const O: u8> = crate::BitWriter<'a, CTRL_SPEC, O>;
