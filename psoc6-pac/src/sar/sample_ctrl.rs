...
pub type LEFT_ALIGN_R = crate::BitReader;
...
pub type LEFT_ALIGN_W<'a, const O: u8> = crate::BitWriter<'a, SAMPLE_CTRL_SPEC, O>;
...
pub type SINGLE_ENDED_SIGNED_W<'a, const O: u8> =
    crate::BitWriter<'a, SAMPLE_CTRL_SPEC, O, SINGLE_ENDED_SIGNED_A>;
...
pub type DIFFERENTIAL_SIGNED_W<'a, const O: u8> =
    crate::BitWriter<'a, SAMPLE_CTRL_SPEC, O, DIFFERENTIAL_SIGNED_A>;
...
pub type AVG_CNT_R = crate::FieldReader;
...
pub type AVG_MODE_W<'a, const O: u8> = crate::BitWriter<'a, SAMPLE_CTRL_SPEC, O, AVG_MODE_A>;
...
pub type CONTINUOUS_W<'a, const O: u8> = crate::BitWriter<'a, SAMPLE_CTRL_SPEC, O>;
...
pub type DSI_TRIGGER_EN_R = crate::BitReader;
...
pub type DSI_TRIGGER_EN_W<'a, const O: u8> = crate::BitWriter<'a, SAMPLE_CTRL_SPEC, O>;
...
pub type DSI_TRIGGER_LEVEL_R = crate::BitReader;
...
pub type DSI_TRIGGER_LEVEL_W<'a, const O: u8> = crate::BitWriter<'a, SAMPLE_CTRL_SPEC, O>;
...
pub type DSI_SYNC_TRIGGER_R = crate::BitReader;
...
pub type DSI_SYNC_TRIGGER_W<'a, const O: u8> = crate::BitWriter<'a, SAMPLE_CTRL_SPEC, O>;
...
pub type UAB_SCAN_MODE_W<'a, const O: u8> =
    crate::BitWriter<'a, SAMPLE_CTRL_SPEC, O, UAB_SCAN_MODE_A>;
...
pub type REPEAT_INVALID_R = crate::BitReader;
#[doc = "Field `REPEAT_INVALID` writer - For unscheduled UAB_SCAN_MODE only, do the following if an invalid sample is received: - 0: use the last known valid sample for that channel and clear the NEWVALUE flag - 1: repeat the conversions until a valid sample is received (caveat: could be never if the UAB valid window is incorrectly schedule w.r.t. SAR sampling)"]
pub type REPEAT_INVALID_W<'a, const O: u8> = crate::BitWriter<'a, SAMPLE_CTRL_SPEC, O>;
...
pub type VALID_SEL_R = crate::FieldReader;
...
pub type VALID_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, SAMPLE_CTRL_SPEC, 3, O>;
#[doc = "Field `VALID_SEL_EN` reader - Enable static UAB Valid selection (override Hardware)"]
pub type VALID_SEL_EN_R = crate::BitReader;
#[doc = "Field `VALID_SEL_EN` writer - Enable static UAB Valid selection (override Hardware)"]
pub type VALID_SEL_EN_W<'a, const O: u8> = crate::BitWriter<'a, SAMPLE_CTRL_SPEC, O>;
...
pub type VALID_IGNORE_R = crate::BitReader;
...
pub type VALID_IGNORE_W<'a, const O: u8> = crate::BitWriter<'a, SAMPLE_CTRL_SPEC, O>;
...
pub type TRIGGER_OUT_EN_R = crate::BitReader;
...
pub type TRIGGER_OUT_EN_W<'a, const O: u8> = crate::BitWriter<'a, SAMPLE_CTRL_SPEC, O>;
...
pub type EOS_DSI_OUT_EN_R = crate::BitReader;
...
pub type EOS_DSI_OUT_EN_W<'a, const O: u8> = crate::BitWriter<'a, SAMPLE_CTRL_SPEC, O>;
impl R {
