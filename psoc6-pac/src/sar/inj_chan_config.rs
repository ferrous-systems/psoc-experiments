...
is ignored and considered to be 0, i.e. INJ_PIN_ADDR points to the even pin of a pin pair."]
pub type INJ_PIN_ADDR_W<'a, const O: u8> = crate::FieldWriter<'a, INJ_CHAN_CONFIG_SPEC, 3, O>;
...
pub type INJ_PORT_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, INJ_CHAN_CONFIG_SPEC, 3, O, INJ_PORT_ADDR_A>;
...
is ignored)."]
pub type INJ_DIFFERENTIAL_EN_W<'a, const O: u8> = crate::BitWriter<'a, INJ_CHAN_CONFIG_SPEC, O>;
...
pub type INJ_AVG_EN_W<'a, const O: u8> = crate::BitWriter<'a, INJ_CHAN_CONFIG_SPEC, O>;
...
pub type INJ_SAMPLE_TIME_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, INJ_CHAN_CONFIG_SPEC, 2, O>;
...
pub type INJ_TAILGATING_W<'a, const O: u8> = crate::BitWriter<'a, INJ_CHAN_CONFIG_SPEC, O>;
...
pub type INJ_START_EN_W<'a, const O: u8> = crate::BitWriter<'a, INJ_CHAN_CONFIG_SPEC, O>;
impl R {
