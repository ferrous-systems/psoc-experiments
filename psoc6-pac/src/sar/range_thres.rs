...
pub type RANGE_LOW_W<'a, const O: u8> = crate::FieldWriter<'a, RANGE_THRES_SPEC, 16, O, u16>;
...
pub type RANGE_HIGH_W<'a, const O: u8> = crate::FieldWriter<'a, RANGE_THRES_SPEC, 16, O, u16>;
impl R {
