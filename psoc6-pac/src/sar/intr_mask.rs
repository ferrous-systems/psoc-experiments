...
pub type EOS_MASK_W<'a, const O: u8> = crate::BitWriter<'a, INTR_MASK_SPEC, O>;
...
pub type OVERFLOW_MASK_W<'a, const O: u8> = crate::BitWriter<'a, INTR_MASK_SPEC, O>;
...
pub type FW_COLLISION_MASK_W<'a, const O: u8> = crate::BitWriter<'a, INTR_MASK_SPEC, O>;
...
pub type DSI_COLLISION_MASK_W<'a, const O: u8> = crate::BitWriter<'a, INTR_MASK_SPEC, O>;
...
pub type INJ_EOC_MASK_W<'a, const O: u8> = crate::BitWriter<'a, INTR_MASK_SPEC, O>;
...
pub type INJ_SATURATE_MASK_W<'a, const O: u8> = crate::BitWriter<'a, INTR_MASK_SPEC, O>;
...
pub type INJ_RANGE_MASK_W<'a, const O: u8> = crate::BitWriter<'a, INTR_MASK_SPEC, O>;
...
pub type INJ_COLLISION_MASK_W<'a, const O: u8> = crate::BitWriter<'a, INTR_MASK_SPEC, O>;
impl R {
