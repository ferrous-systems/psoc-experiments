...
pub type EOS_SET_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SET_SPEC, O>;
...
pub type OVERFLOW_SET_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SET_SPEC, O>;
...
pub type FW_COLLISION_SET_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SET_SPEC, O>;
...
pub type DSI_COLLISION_SET_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SET_SPEC, O>;
...
pub type INJ_EOC_SET_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SET_SPEC, O>;
...
pub type INJ_SATURATE_SET_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SET_SPEC, O>;
...
pub type INJ_RANGE_SET_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SET_SPEC, O>;
...
pub type INJ_COLLISION_SET_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SET_SPEC, O>;
impl R {
