...
pub type SAMPLE_TIME0_W<'a, const O: u8> = crate::FieldWriter<'a, SAMPLE_TIME01_SPEC, 10, O, u16>;
...
pub type SAMPLE_TIME1_W<'a, const O: u8> = crate::FieldWriter<'a, SAMPLE_TIME01_SPEC, 10, O, u16>;
impl R {
