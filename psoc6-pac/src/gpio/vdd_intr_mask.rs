...
pub type VDDIO_ACTIVE_W<'a, const O: u8> = crate::FieldWriter<'a, VDD_INTR_MASK_SPEC, 16, O, u16>;
...
pub type VDDA_ACTIVE_W<'a, const O: u8> = crate::BitWriter<'a, VDD_INTR_MASK_SPEC, O>;
...
pub type VDDD_ACTIVE_W<'a, const O: u8> = crate::BitWriter<'a, VDD_INTR_MASK_SPEC, O>;
impl R {
