...
pub type EDGE0_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPEC, O>;
...
pub type EDGE1_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPEC, O>;
...
pub type EDGE2_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPEC, O>;
...
pub type EDGE3_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPEC, O>;
...
pub type EDGE4_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPEC, O>;
...
pub type EDGE5_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPEC, O>;
...
pub type EDGE6_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPEC, O>;
...
pub type EDGE7_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPEC, O>;
...
pub type FLT_EDGE_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPEC, O>;
