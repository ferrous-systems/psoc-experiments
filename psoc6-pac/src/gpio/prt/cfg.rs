...
pub type DRIVE_MODE0_R = crate::FieldReader<DRIVE_MODE0_A>;
...
impl crate::FieldSpec for DRIVE_MODE0_A {
    type Ux = u8;
}
impl DRIVE_MODE0_R {
...
pub type DRIVE_MODE0_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CFG_SPEC, 3, O, DRIVE_MODE0_A>;
...
pub type IN_EN0_R = crate::BitReader;
