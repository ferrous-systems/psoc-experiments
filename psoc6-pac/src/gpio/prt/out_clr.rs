...
pub type OUT0_W<'a, const O: u8> = crate::BitWriter<'a, OUT_CLR_SPEC, O>;
...
pub type OUT1_W<'a, const O: u8> = crate::BitWriter<'a, OUT_CLR_SPEC, O>;
...
pub type OUT2_W<'a, const O: u8> = crate::BitWriter<'a, OUT_CLR_SPEC, O>;
...
pub type OUT3_W<'a, const O: u8> = crate::BitWriter<'a, OUT_CLR_SPEC, O>;
...
pub type OUT4_W<'a, const O: u8> = crate::BitWriter<'a, OUT_CLR_SPEC, O>;
...
pub type OUT5_W<'a, const O: u8> = crate::BitWriter<'a, OUT_CLR_SPEC, O>;
...
pub type OUT6_W<'a, const O: u8> = crate::BitWriter<'a, OUT_CLR_SPEC, O>;
...
pub type OUT7_W<'a, const O: u8> = crate::BitWriter<'a, OUT_CLR_SPEC, O>;
impl R {
