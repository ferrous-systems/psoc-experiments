...
#[doc = "Generic status"]
pub mod status;
#[doc = "CMD_RESP_CTRL (rw) register accessor: an alias for `Reg<CMD_RESP_CTRL_SPEC>`"]
pub type CMD_RESP_CTRL = crate::Reg<cmd_resp_ctrl::CMD_RESP_CTRL_SPEC>;
#[doc = "Command/response control"]
pub mod cmd_resp_ctrl;
#[doc = "CMD_RESP_STATUS (r) register accessor: an alias for `Reg<CMD_RESP_STATUS_SPEC>`"]
...
pub mod rx_ctrl;
#[doc = "RX_FIFO_CTRL (rw) register accessor: an alias for `Reg<RX_FIFO_CTRL_SPEC>`"]
...
#[doc = "RX_MATCH (rw) register accessor: an alias for `Reg<RX_MATCH_SPEC>`"]
...
pub mod intr_cause;
#[doc = "INTR_I2C_EC (rw) register accessor: an alias for `Reg<INTR_I2C_EC_SPEC>`"]
pub type INTR_I2C_EC = crate::Reg<intr_i2c_ec::INTR_I2C_EC_SPEC>;
#[doc = "Externally clocked I2C interrupt request"]
pub mod intr_i2c_ec;
#[doc = "INTR_I2C_EC_MASK (rw) register accessor: an alias for `Reg<INTR_I2C_EC_MASK_SPEC>`"]
...
#[doc = "INTR_I2C_EC_MASKED (r) register accessor: an alias for `Reg<INTR_I2C_EC_MASKED_SPEC>`"]
...
#[doc = "INTR_SPI_EC (rw) register accessor: an alias for `Reg<INTR_SPI_EC_SPEC>`"]
pub type INTR_SPI_EC = crate::Reg<intr_spi_ec::INTR_SPI_EC_SPEC>;
#[doc = "Externally clocked SPI interrupt request"]
pub mod intr_spi_ec;
#[doc = "INTR_SPI_EC_MASK (rw) register accessor: an alias for `Reg<INTR_SPI_EC_MASK_SPEC>`"]
...
#[doc = "INTR_SPI_EC_MASKED (r) register accessor: an alias for `Reg<INTR_SPI_EC_MASKED_SPEC>`"]
...
#[doc = "INTR_M (rw) register accessor: an alias for `Reg<INTR_M_SPEC>`"]
pub type INTR_M = crate::Reg<intr_m::INTR_M_SPEC>;
#[doc = "Master interrupt request"]
pub mod intr_m;
#[doc = "INTR_M_SET (rw) register accessor: an alias for `Reg<INTR_M_SET_SPEC>`"]
pub type INTR_M_SET = crate::Reg<intr_m_set::INTR_M_SET_SPEC>;
#[doc = "Master interrupt set request"]
pub mod intr_m_set;
#[doc = "INTR_M_MASK (rw) register accessor: an alias for `Reg<INTR_M_MASK_SPEC>`"]
pub type INTR_M_MASK = crate::Reg<intr_m_mask::INTR_M_MASK_SPEC>;
#[doc = "Master interrupt mask"]
pub mod intr_m_mask;
#[doc = "INTR_M_MASKED (r) register accessor: an alias for `Reg<INTR_M_MASKED_SPEC>`"]
...
#[doc = "INTR_S (rw) register accessor: an alias for `Reg<INTR_S_SPEC>`"]
pub type INTR_S = crate::Reg<intr_s::INTR_S_SPEC>;
#[doc = "Slave interrupt request"]
pub mod intr_s;
#[doc = "INTR_S_SET (rw) register accessor: an alias for `Reg<INTR_S_SET_SPEC>`"]
pub type INTR_S_SET = crate::Reg<intr_s_set::INTR_S_SET_SPEC>;
#[doc = "Slave interrupt set request"]
pub mod intr_s_set;
#[doc = "INTR_S_MASK (rw) register accessor: an alias for `Reg<INTR_S_MASK_SPEC>`"]
pub type INTR_S_MASK = crate::Reg<intr_s_mask::INTR_S_MASK_SPEC>;
#[doc = "Slave interrupt mask"]
pub mod intr_s_mask;
#[doc = "INTR_S_MASKED (r) register accessor: an alias for `Reg<INTR_S_MASKED_SPEC>`"]
