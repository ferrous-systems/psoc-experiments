...
pub type DATA0_W<'a, const O: u8> = crate::FieldWriter<'a, TX_DATA_FIFO_WR2_SPEC, 8, O>;
#[doc = "Field `DATA1` writer - TX data (written to TX data FIFO, second byte)."]
pub type DATA1_W<'a, const O: u8> = crate::FieldWriter<'a, TX_DATA_FIFO_WR2_SPEC, 8, O>;
impl W {
