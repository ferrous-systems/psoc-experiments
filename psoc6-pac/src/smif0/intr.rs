...
pub type TR_TX_REQ_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPEC, O>;
...
pub type TR_RX_REQ_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPEC, O>;
...
pub type XIP_ALIGNMENT_ERROR_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPEC, O>;
...
pub type TX_CMD_FIFO_OVERFLOW_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPEC, O>;
...
pub type TX_DATA_FIFO_OVERFLOW_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPEC, O>;
...
pub type RX_DATA_FIFO_UNDERFLOW_W<'a, const O: u8> = crate::BitWriter<'a, INTR_SPEC, O>;
impl R {
