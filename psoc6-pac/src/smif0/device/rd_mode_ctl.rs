...
pub type CODE_W<'a, const O: u8> = crate::FieldWriter<'a, RD_MODE_CTL_SPEC, 8, O>;
#[doc = "Field `WIDTH` reader - Width of transfer."]
pub type WIDTH_R = crate::FieldReader;
#[doc = "Field `WIDTH` writer - Width of transfer."]
pub type WIDTH_W<'a, const O: u8> = crate::FieldWriter<'a, RD_MODE_CTL_SPEC, 2, O>;
...
pub type PRESENT_W<'a, const O: u8> = crate::BitWriter<'a, RD_MODE_CTL_SPEC, O>;
impl R {
