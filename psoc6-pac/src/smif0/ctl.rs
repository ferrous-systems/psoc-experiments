...
pub type XIP_MODE_W<'a, const O: u8> = crate::BitWriter<'a, CTL_SPEC, O, XIP_MODE_A>;
...
pub type CLOCK_IF_RX_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, CTL_SPEC, 2, O>;
...
pub type DESELECT_DELAY_W<'a, const O: u8> = crate::FieldWriter<'a, CTL_SPEC, 3, O>;
...
pub type BLOCK_W<'a, const O: u8> = crate::BitWriter<'a, CTL_SPEC, O, BLOCK_A>;
...
pub type ENABLED_W<'a, const O: u8> = crate::BitWriter<'a, CTL_SPEC, O, ENABLED_A>;
