...
pub type DATA0_W<'a, const O: u8> = crate::FieldWriter<'a, TX_DATA_FIFO_WR4_SPEC, 8, O>;
#[doc = "Field `DATA1` writer - TX data (written to TX data FIFO, second byte)."]
pub type DATA1_W<'a, const O: u8> = crate::FieldWriter<'a, TX_DATA_FIFO_WR4_SPEC, 8, O>;
#[doc = "Field `DATA2` writer - TX data (written to TX data FIFO, third byte)."]
pub type DATA2_W<'a, const O: u8> = crate::FieldWriter<'a, TX_DATA_FIFO_WR4_SPEC, 8, O>;
#[doc = "Field `DATA3` writer - TX data (written to TX data FIFO, fourth byte)."]
pub type DATA3_W<'a, const O: u8> = crate::FieldWriter<'a, TX_DATA_FIFO_WR4_SPEC, 8, O>;
impl W {
