...
pub type TR_EN_W<'a, const O: u8> = crate::BitWriter<'a, CTL_SPEC, O>;
...
pub type OUT_EN_W<'a, const O: u8> = crate::BitWriter<'a, CTL_SPEC, O>;
...
pub type RESET_REQ_EN_W<'a, const O: u8> = crate::BitWriter<'a, CTL_SPEC, O>;
impl R {
