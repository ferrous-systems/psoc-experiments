...
#[doc = "SEQ_PROGRAM_CTL_1 (rw) register accessor: an alias for `Reg<SEQ_PROGRAM_CTL_1_SPEC>`"]
...
#[doc = "SEQ_PROGRAM_CTL_2 (rw) register accessor: an alias for `Reg<SEQ_PROGRAM_CTL_2_SPEC>`"]
...
#[doc = "SEQ_PROGRAM_CTL_3 (rw) register accessor: an alias for `Reg<SEQ_PROGRAM_CTL_3_SPEC>`"]
...
#[doc = "SEQ_PROGRAM_CTL_4 (rw) register accessor: an alias for `Reg<SEQ_PROGRAM_CTL_4_SPEC>`"]
...
#[doc = "SEQ_PROGRAM_CTL_5 (rw) register accessor: an alias for `Reg<SEQ_PROGRAM_CTL_5_SPEC>`"]
