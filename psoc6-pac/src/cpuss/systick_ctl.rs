...
pub type TENMS_W<'a, const O: u8> = crate::FieldWriter<'a, SYSTICK_CTL_SPEC, 24, O, u32>;
...
pub type CLOCK_SOURCE_W<'a, const O: u8> = crate::FieldWriter<'a, SYSTICK_CTL_SPEC, 2, O>;
...
pub type SKEW_W<'a, const O: u8> = crate::BitWriter<'a, SYSTICK_CTL_SPEC, O>;
...
pub type NOREF_W<'a, const O: u8> = crate::BitWriter<'a, SYSTICK_CTL_SPEC, O>;
impl R {
