...
#[doc = "Field `UP` reader - Number clock cycles (clk_slow) delay needed after power domain power up"]
pub type UP_R = crate::FieldReader<u16>;
#[doc = "Field `UP` writer - Number clock cycles (clk_slow) delay needed after power domain power up"]
pub type UP_W<'a, const O: u8> = crate::FieldWriter<'a, RAM_PWR_DELAY_CTL_SPEC, 10, O, u16>;
impl R {
    #[doc = "Bits 0:9 - Number clock cycles (clk_slow) delay needed after power domain power up"]
    #[inline(always)]
    pub fn up(&self) -> UP_R {
...
impl crate::Resettable for RAM_PWR_DELAY_CTL_SPEC {
    const RESET_VALUE: Self::Ux = 0x96;
}
