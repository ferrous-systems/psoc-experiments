...
pub struct R(crate::R<CM4_INT5_STATUS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CM4_INT5_STATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CM4_INT5_STATUS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CM4_INT5_STATUS_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "CM4 interrupt 5 status\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cm4_int5_status](index.html) module"]
