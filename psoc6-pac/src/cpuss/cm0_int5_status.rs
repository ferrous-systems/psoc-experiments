...
pub struct R(crate::R<CM0_INT5_STATUS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CM0_INT5_STATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CM0_INT5_STATUS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CM0_INT5_STATUS_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "CM0+ interrupt 5 status\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cm0_int5_status](index.html) module"]
pub struct CM0_INT5_STATUS_SPEC;
impl crate::RegisterSpec for CM0_INT5_STATUS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cm0_int5_status::R](R) reader structure"]
impl crate::Readable for CM0_INT5_STATUS_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CM0_INT5_STATUS to value 0"]
impl crate::Resettable for CM0_INT5_STATUS_SPEC {
