...
pub type ECC_AUTO_CORRECT_W<'a, const O: u8> = crate::BitWriter<'a, RAM1_CTL0_SPEC, O>;
#[doc = "Field `ECC_INJ_EN` reader - See RAM0_CTL."]
pub type ECC_INJ_EN_R = crate::BitReader;
#[doc = "Field `ECC_INJ_EN` writer - See RAM0_CTL."]
pub type ECC_INJ_EN_W<'a, const O: u8> = crate::BitWriter<'a, RAM1_CTL0_SPEC, O>;
impl R {
