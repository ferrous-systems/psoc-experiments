...
pub struct R(crate::R<CM4_INT4_STATUS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CM4_INT4_STATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CM4_INT4_STATUS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CM4_INT4_STATUS_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "CM4 interrupt 4 status\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cm4_int4_status](index.html) module"]
pub struct CM4_INT4_STATUS_SPEC;
impl crate::RegisterSpec for CM4_INT4_STATUS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cm4_int4_status::R](R) reader structure"]
impl crate::Readable for CM4_INT4_STATUS_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CM4_INT4_STATUS to value 0"]
impl crate::Resettable for CM4_INT4_STATUS_SPEC {
