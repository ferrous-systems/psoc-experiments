...
pub type BIT_DATA_W<'a, const O: u8> = crate::BitWriter<'a, CMD_SPEC, O>;
...
pub type BIT_ADDR_W<'a, const O: u8> = crate::FieldWriter<'a, CMD_SPEC, 3, O>;
...
pub type BYTE_ADDR_W<'a, const O: u8> = crate::FieldWriter<'a, CMD_SPEC, 5, O>;
...
pub type MACRO_ADDR_W<'a, const O: u8> = crate::FieldWriter<'a, CMD_SPEC, 4, O>;
