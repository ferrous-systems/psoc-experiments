...
IP clock cycles."]
pub type CYCLES_W<'a, const O: u8> = crate::FieldWriter<'a, SEQ_READ_CTL_3_SPEC, 10, O, u16>;
...
pub type STROBE_A_W<'a, const O: u8> = crate::BitWriter<'a, SEQ_READ_CTL_3_SPEC, O>;
...
pub type STROBE_B_W<'a, const O: u8> = crate::BitWriter<'a, SEQ_READ_CTL_3_SPEC, O>;
...
pub type STROBE_C_W<'a, const O: u8> = crate::BitWriter<'a, SEQ_READ_CTL_3_SPEC, O>;
...
pub type STROBE_D_W<'a, const O: u8> = crate::BitWriter<'a, SEQ_READ_CTL_3_SPEC, O>;
...
pub type STROBE_E_W<'a, const O: u8> = crate::BitWriter<'a, SEQ_READ_CTL_3_SPEC, O>;
...
pub type STROBE_F_W<'a, const O: u8> = crate::BitWriter<'a, SEQ_READ_CTL_3_SPEC, O>;
...
pub type STROBE_G_W<'a, const O: u8> = crate::BitWriter<'a, SEQ_READ_CTL_3_SPEC, O>;
...
pub type DONE_W<'a, const O: u8> = crate::BitWriter<'a, SEQ_READ_CTL_3_SPEC, O>;
impl R {
...
impl crate::Resettable for SEQ_READ_CTL_3_SPEC {
    const RESET_VALUE: Self::Ux = 0x0054_0003;
}
