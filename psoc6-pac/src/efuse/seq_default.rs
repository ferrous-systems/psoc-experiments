...
pub type STROBE_A_W<'a, const O: u8> = crate::BitWriter<'a, SEQ_DEFAULT_SPEC, O>;
...
pub type STROBE_B_W<'a, const O: u8> = crate::BitWriter<'a, SEQ_DEFAULT_SPEC, O>;
...
pub type STROBE_C_W<'a, const O: u8> = crate::BitWriter<'a, SEQ_DEFAULT_SPEC, O>;
...
pub type STROBE_D_W<'a, const O: u8> = crate::BitWriter<'a, SEQ_DEFAULT_SPEC, O>;
...
pub type STROBE_E_W<'a, const O: u8> = crate::BitWriter<'a, SEQ_DEFAULT_SPEC, O>;
...
pub type STROBE_F_W<'a, const O: u8> = crate::BitWriter<'a, SEQ_DEFAULT_SPEC, O>;
...
pub type STROBE_G_W<'a, const O: u8> = crate::BitWriter<'a, SEQ_DEFAULT_SPEC, O>;
impl R {
...
impl crate::Resettable for SEQ_DEFAULT_SPEC {
    const RESET_VALUE: Self::Ux = 0x001d_0000;
}
