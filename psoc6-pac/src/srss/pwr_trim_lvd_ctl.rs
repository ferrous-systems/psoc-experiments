...
pub type HVLVD1_OFSTRIM_W<'a, const O: u8> = crate::FieldWriter<'a, PWR_TRIM_LVD_CTL_SPEC, 3, O>;
...
pub type HVLVD1_ITRIM_W<'a, const O: u8> = crate::FieldWriter<'a, PWR_TRIM_LVD_CTL_SPEC, 3, O>;
impl R {
