...
pub type PILO_FFREQ_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_PILO_CONFIG_SPEC, 10, O, u16>;
...
pub type PILO_CLK_EN_W<'a, const O: u8> = crate::BitWriter<'a, CLK_PILO_CONFIG_SPEC, O>;
...
pub type PILO_RESET_N_W<'a, const O: u8> = crate::BitWriter<'a, CLK_PILO_CONFIG_SPEC, O>;
...
pub type PILO_EN_W<'a, const O: u8> = crate::BitWriter<'a, CLK_PILO_CONFIG_SPEC, O>;
impl R {
