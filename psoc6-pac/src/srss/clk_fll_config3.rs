...
pub type FLL_LF_IGAIN_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_FLL_CONFIG3_SPEC, 4, O>;
...
pub type FLL_LF_PGAIN_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_FLL_CONFIG3_SPEC, 4, O>;
...
pub type SETTLING_COUNT_W<'a, const O: u8> =
    crate::FieldWriter<'a, CLK_FLL_CONFIG3_SPEC, 13, O, u16>;
...
pub type BYPASS_SEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, CLK_FLL_CONFIG3_SPEC, 2, O, BYPASS_SEL_A>;
