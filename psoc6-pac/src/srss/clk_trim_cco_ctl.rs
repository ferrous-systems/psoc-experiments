...
pub type CCO_RCSTRIM_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_TRIM_CCO_CTL_SPEC, 6, O>;
...
pub type CCO_STABLE_CNT_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_TRIM_CCO_CTL_SPEC, 6, O>;
...
pub type ENABLE_CNT_W<'a, const O: u8> = crate::BitWriter<'a, CLK_TRIM_CCO_CTL_SPEC, O>;
impl R {
