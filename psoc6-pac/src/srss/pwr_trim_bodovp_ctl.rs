...
pub type HVPORBOD_TRIPSEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, PWR_TRIM_BODOVP_CTL_SPEC, 3, O>;
...
pub type HVPORBOD_ITRIM_W<'a, const O: u8> = crate::FieldWriter<'a, PWR_TRIM_BODOVP_CTL_SPEC, 3, O>;
...
pub type LVPORBOD_ITRIM_W<'a, const O: u8> = crate::FieldWriter<'a, PWR_TRIM_BODOVP_CTL_SPEC, 3, O>;
impl R {
