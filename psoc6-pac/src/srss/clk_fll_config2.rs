...
pub type FLL_REF_DIV_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_FLL_CONFIG2_SPEC, 13, O, u16>;
...
pub type LOCK_TOL_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_FLL_CONFIG2_SPEC, 9, O, u16>;
impl R {
