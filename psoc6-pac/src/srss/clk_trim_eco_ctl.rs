...
pub type WDTRIM_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_TRIM_ECO_CTL_SPEC, 3, O>;
...
pub type ATRIM_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_TRIM_ECO_CTL_SPEC, 4, O>;
...
pub type FTRIM_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_TRIM_ECO_CTL_SPEC, 2, O>;
...
pub type RTRIM_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_TRIM_ECO_CTL_SPEC, 2, O>;
...
pub type GTRIM_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_TRIM_ECO_CTL_SPEC, 2, O>;
#[doc = "Field `ITRIM` reader - Current Trim"]
pub type ITRIM_R = crate::FieldReader;
#[doc = "Field `ITRIM` writer - Current Trim"]
pub type ITRIM_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_TRIM_ECO_CTL_SPEC, 6, O>;
impl R {
