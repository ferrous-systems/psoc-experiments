...
pub type RESET_WDT_W<'a, const O: u8> = crate::BitWriter<'a, RES_CAUSE_SPEC, O>;
...
pub type RESET_ACT_FAULT_W<'a, const O: u8> = crate::BitWriter<'a, RES_CAUSE_SPEC, O>;
...
pub type RESET_DPSLP_FAULT_W<'a, const O: u8> = crate::BitWriter<'a, RES_CAUSE_SPEC, O>;
...
pub type RESET_CSV_WCO_LOSS_W<'a, const O: u8> = crate::BitWriter<'a, RES_CAUSE_SPEC, O>;
...
pub type RESET_SOFT_W<'a, const O: u8> = crate::BitWriter<'a, RES_CAUSE_SPEC, O>;
...
pub type RESET_MCWDT0_W<'a, const O: u8> = crate::BitWriter<'a, RES_CAUSE_SPEC, O>;
...
pub type RESET_MCWDT1_W<'a, const O: u8> = crate::BitWriter<'a, RES_CAUSE_SPEC, O>;
...
pub type RESET_MCWDT2_W<'a, const O: u8> = crate::BitWriter<'a, RES_CAUSE_SPEC, O>;
...
pub type RESET_MCWDT3_W<'a, const O: u8> = crate::BitWriter<'a, RES_CAUSE_SPEC, O>;
impl R {
