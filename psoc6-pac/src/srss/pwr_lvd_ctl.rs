...
pub type HVLVD1_TRIPSEL_W<'a, const O: u8> = crate::FieldWriter<'a, PWR_LVD_CTL_SPEC, 4, O>;
...
pub type HVLVD1_SRCSEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, PWR_LVD_CTL_SPEC, 3, O, HVLVD1_SRCSEL_A>;
...
pub type HVLVD1_EN_W<'a, const O: u8> = crate::BitWriter<'a, PWR_LVD_CTL_SPEC, O>;
impl R {
