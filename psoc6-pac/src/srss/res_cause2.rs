...
pub type RESET_CSV_HF_LOSS_W<'a, const O: u8> = crate::FieldWriter<'a, RES_CAUSE2_SPEC, 16, O, u16>;
...
pub type RESET_CSV_HF_FREQ_W<'a, const O: u8> = crate::FieldWriter<'a, RES_CAUSE2_SPEC, 16, O, u16>;
impl R {
