...
pub type PILO_VREF_TRIM_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_TRIM_PILO_CTL2_SPEC, 8, O>;
...
pub type PILO_IREFBM_TRIM_W<'a, const O: u8> =
    crate::FieldWriter<'a, CLK_TRIM_PILO_CTL2_SPEC, 5, O>;
...
pub type PILO_IREF_TRIM_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_TRIM_PILO_CTL2_SPEC, 8, O>;
impl R {
