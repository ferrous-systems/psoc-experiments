...
pub type MCWDT_INT0_W<'a, const O: u8> = crate::BitWriter<'a, MCWDT_INTR_SET_SPEC, O>;
...
pub type MCWDT_INT1_W<'a, const O: u8> = crate::BitWriter<'a, MCWDT_INTR_SET_SPEC, O>;
...
pub type MCWDT_INT2_W<'a, const O: u8> = crate::BitWriter<'a, MCWDT_INTR_SET_SPEC, O>;
impl R {
