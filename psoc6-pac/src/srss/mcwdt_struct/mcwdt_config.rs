...
pub type WDT_MODE0_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, MCWDT_CONFIG_SPEC, 2, O, WDT_MODE0_A>;
...
pub type WDT_CLEAR0_W<'a, const O: u8> = crate::BitWriter<'a, MCWDT_CONFIG_SPEC, O>;
...
pub type WDT_CASCADE0_1_W<'a, const O: u8> = crate::BitWriter<'a, MCWDT_CONFIG_SPEC, O>;
...
pub type WDT_MODE1_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, MCWDT_CONFIG_SPEC, 2, O, WDT_MODE1_A>;
...
pub type WDT_CLEAR1_W<'a, const O: u8> = crate::BitWriter<'a, MCWDT_CONFIG_SPEC, O>;
...
pub type WDT_CASCADE1_2_W<'a, const O: u8> = crate::BitWriter<'a, MCWDT_CONFIG_SPEC, O>;
...
pub type WDT_MODE2_W<'a, const O: u8> = crate::BitWriter<'a, MCWDT_CONFIG_SPEC, O, WDT_MODE2_A>;
...
pub type WDT_BITS2_W<'a, const O: u8> = crate::FieldWriter<'a, MCWDT_CONFIG_SPEC, 5, O>;
impl R {
