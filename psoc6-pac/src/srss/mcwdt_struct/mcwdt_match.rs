...
pub type WDT_MATCH0_W<'a, const O: u8> = crate::FieldWriter<'a, MCWDT_MATCH_SPEC, 16, O, u16>;
...
pub type WDT_MATCH1_W<'a, const O: u8> = crate::FieldWriter<'a, MCWDT_MATCH_SPEC, 16, O, u16>;
impl R {
