...
pub type WDT_ENABLE0_W<'a, const O: u8> = crate::BitWriter<'a, MCWDT_CTL_SPEC, O>;
...
pub type WDT_RESET0_W<'a, const O: u8> = crate::BitWriter<'a, MCWDT_CTL_SPEC, O>;
...
pub type WDT_ENABLE1_W<'a, const O: u8> = crate::BitWriter<'a, MCWDT_CTL_SPEC, O>;
...
pub type WDT_RESET1_W<'a, const O: u8> = crate::BitWriter<'a, MCWDT_CTL_SPEC, O>;
...
pub type WDT_ENABLE2_W<'a, const O: u8> = crate::BitWriter<'a, MCWDT_CTL_SPEC, O>;
...
pub type WDT_RESET2_W<'a, const O: u8> = crate::BitWriter<'a, MCWDT_CTL_SPEC, O>;
impl R {
