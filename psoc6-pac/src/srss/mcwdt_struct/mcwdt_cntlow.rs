...
pub type WDT_CTR0_W<'a, const O: u8> = crate::FieldWriter<'a, MCWDT_CNTLOW_SPEC, 16, O, u16>;
...
pub type WDT_CTR1_W<'a, const O: u8> = crate::FieldWriter<'a, MCWDT_CNTLOW_SPEC, 16, O, u16>;
impl R {
