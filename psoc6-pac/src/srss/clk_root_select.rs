...
pub type ROOT_MUX_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, CLK_ROOT_SELECT_SPEC, 4, O, ROOT_MUX_A>;
...
pub type ROOT_DIV_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, CLK_ROOT_SELECT_SPEC, 2, O, ROOT_DIV_A>;
...
pub type ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, CLK_ROOT_SELECT_SPEC, O>;
impl R {
