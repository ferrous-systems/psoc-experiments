...
pub type CCO_LIMIT_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_FLL_CONFIG4_SPEC, 8, O>;
...
pub type CCO_RANGE_W<'a, const O: u8> =
    crate::FieldWriter<'a, CLK_FLL_CONFIG4_SPEC, 3, O, CCO_RANGE_A>;
...
pub type CCO_FREQ_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_FLL_CONFIG4_SPEC, 9, O, u16>;
...
pub type CCO_HW_UPDATE_DIS_W<'a, const O: u8> = crate::BitWriter<'a, CLK_FLL_CONFIG4_SPEC, O>;
...
pub type CCO_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, CLK_FLL_CONFIG4_SPEC, O>;
impl R {
