...
pub type ACT_REG_TRIM_W<'a, const O: u8> = crate::FieldWriter<'a, PWR_TRIM_PWRSYS_CTL_SPEC, 5, O>;
...
pub type ACT_REG_BOOST_W<'a, const O: u8> = crate::FieldWriter<'a, PWR_TRIM_PWRSYS_CTL_SPEC, 2, O>;
impl R {
