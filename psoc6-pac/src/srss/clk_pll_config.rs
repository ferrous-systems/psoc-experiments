...
pub type FEEDBACK_DIV_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_PLL_CONFIG_SPEC, 7, O>;
...
pub type REFERENCE_DIV_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_PLL_CONFIG_SPEC, 5, O>;
...
pub type OUTPUT_DIV_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_PLL_CONFIG_SPEC, 5, O>;
...
1: VCO frequency is \\[170MHz, 200MHz)"]
pub type PLL_LF_MODE_W<'a, const O: u8> = crate::BitWriter<'a, CLK_PLL_CONFIG_SPEC, O>;
...
pub type BYPASS_SEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, CLK_PLL_CONFIG_SPEC, 2, O, BYPASS_SEL_A>;
...
pub type ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, CLK_PLL_CONFIG_SPEC, O>;
impl R {
