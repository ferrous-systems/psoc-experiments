...
pub type PILO_CFREQ_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_TRIM_PILO_CTL_SPEC, 6, O>;
...
pub type PILO_OSC_TRIM_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_TRIM_PILO_CTL_SPEC, 3, O>;
...
pub type PILO_COMP_TRIM_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_TRIM_PILO_CTL_SPEC, 2, O>;
...
pub type PILO_NBIAS_TRIM_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_TRIM_PILO_CTL_SPEC, 2, O>;
...
pub type PILO_RES_TRIM_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_TRIM_PILO_CTL_SPEC, 5, O>;
...
pub type PILO_ISLOPE_TRIM_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_TRIM_PILO_CTL_SPEC, 2, O>;
...
pub type PILO_VTDIFF_TRIM_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_TRIM_PILO_CTL_SPEC, 3, O>;
impl R {
