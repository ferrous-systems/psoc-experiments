...
pub type BUCK_OUT2_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, PWR_BUCK_CTL2_SPEC, 3, O>;
...
pub type BUCK_OUT2_HW_SEL_W<'a, const O: u8> = crate::BitWriter<'a, PWR_BUCK_CTL2_SPEC, O>;
...
pub type BUCK_OUT2_EN_W<'a, const O: u8> = crate::BitWriter<'a, PWR_BUCK_CTL2_SPEC, O>;
impl R {
