...
pub type CCO_FCTRIM1_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_TRIM_CCO_CTL2_SPEC, 5, O>;
...
pub type CCO_FCTRIM2_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_TRIM_CCO_CTL2_SPEC, 5, O>;
...
pub type CCO_FCTRIM3_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_TRIM_CCO_CTL2_SPEC, 5, O>;
...
pub type CCO_FCTRIM4_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_TRIM_CCO_CTL2_SPEC, 5, O>;
...
pub type CCO_FCTRIM5_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_TRIM_CCO_CTL2_SPEC, 5, O>;
impl R {
