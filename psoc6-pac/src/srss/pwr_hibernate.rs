...
pub type TOKEN_W<'a, const O: u8> = crate::FieldWriter<'a, PWR_HIBERNATE_SPEC, 8, O>;
...
pub type UNLOCK_W<'a, const O: u8> = crate::FieldWriter<'a, PWR_HIBERNATE_SPEC, 8, O>;
...
pub type FREEZE_W<'a, const O: u8> = crate::BitWriter<'a, PWR_HIBERNATE_SPEC, O>;
...
pub type MASK_HIBALARM_W<'a, const O: u8> = crate::BitWriter<'a, PWR_HIBERNATE_SPEC, O>;
...
pub type MASK_HIBWDT_W<'a, const O: u8> = crate::BitWriter<'a, PWR_HIBERNATE_SPEC, O>;
...
pub type POLARITY_HIBPIN_W<'a, const O: u8> = crate::FieldWriter<'a, PWR_HIBERNATE_SPEC, 4, O>;
...
pub type MASK_HIBPIN_W<'a, const O: u8> = crate::FieldWriter<'a, PWR_HIBERNATE_SPEC, 4, O>;
...
pub type HIBERNATE_DISABLE_W<'a, const O: u8> = crate::BitWriter<'a, PWR_HIBERNATE_SPEC, O>;
...
pub type HIBERNATE_W<'a, const O: u8> = crate::BitWriter<'a, PWR_HIBERNATE_SPEC, O>;
impl R {
